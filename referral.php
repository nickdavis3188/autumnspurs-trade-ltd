...
?>
  <!DOCTYPE html>
  <!-- saved from url=(0034)https://phantomstrade .com/referral -->
  <html lang="en">
  ...
  <head>
    ...
    <link href="./referral_files/app.min05.css" rel="stylesheet">
    <!-- ================== END BASE CSS STYLE ================== -->
    <!-- ================== BEGIN PAGE LEVEL CSS STYLE ================== -->
    <link href="./referral_files/jquery-jvectormap.css" rel="stylesheet">
    <link href="https://phantomstrade .com/public/plugins/nvd3/build/nv.d3.css%22%20rel=%22stylesheet">
    <link href="./referral_files/daterangepicker.css" rel="stylesheet">
    <script src="./referral_files/jquery.min.js.download"></script>
    <link href="./referral_files/bootstrap-social.css" rel="stylesheet">
    <link href="./favicon.ico" rel="shortcut icon" type="image/x-icon" />
    <link href="./favicon.ico" rel="apple-touch-icon" />
    <script src="./referral_files/3233d881f8.js.download" crossorigin="anonymous"></script>
 ...
 */
    ...
    <link href="./referral_files/switchery.min.css" rel="stylesheet">
    <script src="./referral_files/w8wb9dgtssqmlqs9zznww11ibjxvsp8g.js.download" async=""></script>
  ...
  <body class="  pace-done" data-new-gr-c-s-check-loaded="14.1031.0" data-gr-ext-installed="">
    ...
    <div id="page-container" class="fade page-sidebar-fixed page-header-fixed show">
      ...
      <div id="header" class="header navbar-default">
        ...
        <ul class="navbar-nav navbar-right">
            ...
            <form action="#" method="POST" name="search_form">
              ...
              <div class="form-group">
                <div class="badge badge-dark" style="
                    ...
                    padding: 10px;
                    font-size: 0.7rem;
                  " id="clockbox">Jun-29-2023, 10:56:38 AM</div>
          ...
          <li class="dropdown navbar-user">
            <a href="./referral.php#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="./referral_files/myuser.jpg" alt="">
      ...
      <div id="content" class="content">
        ...
        <h1 class="page-header mb-3">
          <i class="far fa-handshake" aria-hidden="true"></i> Referral Program
        </h1>
        <!-- end page-header -->
            ...
            <div class="card border-0 mb-3 overflow-hidden">
              ...
              <div class="card-body">
                ...
                <div class="row" style="max-width: 1200px">
                  ...
                  <!-- end col-5 -->
                  <!-- begin col-7 -->
                  <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12 d-flex justify-content-center">
                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="30 50 280 300" style="
                        max-height: 200px;
                        margin-bottom: -20px;
                        margin-top: -20px;
                      ">
                  ...
                  <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12 mt-3">
                    <!-- begin title -->
                    <!-- end title -->
                    <!-- begin total-sales -->
                      ...
                      <table class="table table-hover m-b-0 text-white">
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td>
                              <i class="fa fa-users" style="font-size: 0.8rem; color: grey" aria-hidden="true"></i><span class="text-muted">&nbsp;0</span>
                            </td>
                          </tr>
                          <tr>
                            <th>Active Referrals</th>
                            <td>
                              <i class="fa fa-users" style="font-size: 0.8rem; color: silver" aria-hidden="true"></i><span class="text-muted">&nbsp;0</span>
                            </td>
                          </tr>
                          <tr>
                        ...
                        <div class="widget-list-title">
                          <div class="input-group">
                            <input style="
                                ...
                                font-weight: 600;
                                font-size: 0.8rem;
                              " id="reflink" type="text" class="form-control" value="https://autumnSpurs.com/register.php/64890106cb03247b672d7a98">
    ...
    <!-- end page container -->
    <!-- ================== BEGIN BASE JS ================== -->
    <script src="./referral_files/app.min.js.download"></script>
    <script src="./referral_files/transparent.min.js.download"></script>
    <!-- ================== END BASE JS ================== -->
    <!-- ================== BEGIN PAGE LEVEL JS ================== -->
    <script src="./referral_files/d3.min.js.download"></script>
    <script src="./referral_files/nv.d3.min.js.download"></script>
    <script src="./referral_files/jquery-jvectormap.min.js.download"></script>
    <script src="./referral_files/jquery-jvectormap-world-mill.js.download"></script>
    <script src="./referral_files/apexcharts.min.js.download"></script>
    <script src="./referral_files/moment.min.js.download"></script>
    <script src="./referral_files/daterangepicker.js.download"></script>

    <script src="./referral_files/script36e.js.download"></script>
    <script src="./referral_files/recent.js.download"></script>
