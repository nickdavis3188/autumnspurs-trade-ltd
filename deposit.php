...
?>
  ...
  <head>
    ...
    <link href="./Deposit_files/app.min05.css" rel="stylesheet">
    <!-- ================== END BASE CSS STYLE ================== -->
    <!-- ================== BEGIN PAGE LEVEL CSS STYLE ================== -->
    <link href="./Deposit_files/jquery-jvectormap.css" rel="stylesheet">
    <link href="https://phantomstrade .com/public/plugins/nvd3/build/nv.d3.css%22%20rel=%22stylesheet">
    <link href="./Deposit_files/daterangepicker.css" rel="stylesheet">
    <script src="./Deposit_files/jquery.min.js.download"></script>
    <link href="./Deposit_files/bootstrap-social.css" rel="stylesheet">
    <script src="./Deposit_files/3233d881f8.js.download" crossorigin="anonymous"></script>
 ...
 */
    ...
    <link href="./Deposit_files/switchery.min.css" rel="stylesheet">
    <script src="./Deposit_files/w8wb9dgtssqmlqs9zznww11ibjxvsp8g.js.download" async=""></script>
  ...
  <body class="  pace-done" data-new-gr-c-s-check-loaded="14.1031.0" data-gr-ext-installed="">
    ...
    <div id="page-container" class="fade page-sidebar-fixed page-header-fixed show">
      ...
      <div id="header" class="header navbar-default">
        ...
        <ul class="navbar-nav navbar-right">
          <li class="navbar-form">
            <form action="#" method="POST" name="search_form"><input type="hidden" name="form_id" value="16192493844200"><input type="hidden" name="form_token" value="d87f2db94eacfc63c8edf01222de01ad">
              <div class="form-group">
                <div class="badge badge-dark" style="margin-top: 2px; margin-bottom: auto; padding: 10px; font-size: 0.7rem" id="clockbox">Jun-24-2023, 7:59:30 AM</div>
          ...
          <li class="dropdown navbar-user">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown"> <img src="./Deposit_files/myuser.jpg" alt="">
              <span class="d-none d-md-inline"><?php echo ($_SESSION['userName']) ?></span> <b class="caret"></b>
            </a>
            <div class="dropdown-menu dropdown-menu-right">
              <a href="./profile.php" class="dropdown-item"><i class="fa fa-edit" aria-hidden="true">
                </i>&nbsp;&nbsp;Edit Account
              </a>
      ...
      <style>
        ...
        input[type="radio"]:checked+label {
          ...
          c: hsla(215, 0%, 100%, 1);
          box-shadow: 0px 0px 10px #00acac;
        }
        ...
        input[type="radio"]:checked+label .x2 {
          color: #00acac;
        }
      ...
      <div id="content" class="content">
        ...
        <form method="post" action="./controller/invoiceController.php">

          <input type="hidden" name="dateTime" value="<?php echo date('Y-m-d'); ?>">
          <input type="hidden" name="userId" value="<?php echo $_SESSION['id']; ?>">
          <div class="row">
            <div class="col-xl-8 col-12 ui-sortable">
              <!-- begin panel -->
              <div class="panel panel-inverse">
                <!-- begin panel-heading -->
                <div class="panel-heading ui-sortable-handle">
                  <h4 class="panel-title">SELECT INVESTMENT PLAN</h4>
                </div>
                <!-- end panel-heading -->
                <!-- begin alert -->
                <!-- end alert -->
                ...
                <div class="panel-body">
                  <section>
                    ...
                    <div>
                      <input type="radio" id="control_01" name="package" value="standard" checked="">
                      <label for="control_01">
                        <h3 class="x2">Standard</h3>
                        <div class="d-md-inline-block">



                          <p class="mb-1">Referral bonus:7%</p>
                          <p class="mb-1">CANCEL AT ANY TIME</p>
                        </div>
                      </label>
                    </div>
                    ...
                    <div>
                      <input type="radio" id="control_02" name="package" value="advanced">
                      <label for="control_02">
                        <h3 class="x2">Advanced</h3>
                        <div class="d-md-inline-block">
                    ...
                    <div>
                      <input type="radio" id="control_03" name="package" value="nfp">
                    ...
                    <div>
                      <input type="radio" id="control_04" name="package" value="btc">
            ...
            <div class="col-xl-4 ui-sortable">
              ...
              <div class="panel panel-inverse">
                <!-- begin panel-heading -->
                <div class="panel-heading ui-sortable-handle">
                  <h4 class="panel-title">SELECT PAYMENT METHOD AND INPUT AMOUNT</h4>
                </div>
                <!-- end panel-heading -->
                <!-- begin alert -->
                <!-- end alert -->
                ...
                <div class="panel-body" style="margin-bottom: 5px">
                  <select name="channel" style="font-size: 14px;" class="mt-2 mb-4 form-control font-weight-bold">


                    <option style="background-color: #545454" name="type" value="ETH">Ethereum</option>

                    <option style="background-color: #545454" name="type" value="USDT">Tether</option>

                    <option style="background-color: #545454" name="type" value="USDC">USD Coin</option>

                    <option style="background-color: #545454" name="type" value="BTC">Bitcoin </option>


                    <!-- <option style="background-color: #545454" name="type" value="Btc">Bitcoin</option>
              
              <option style="background-color: #545454" name="type" value="Eth">Ethereum</option>
              <option style="background-color: #545454" name="type" value="Bch">BNB</option>
              
              <option style="background-color: #545454" name="type" value="Usdt">USDT (ERC20)</option> -->

                  </select>
                  <div class="input-group mb-1 pt-2">
                    <div class="input-group-prepend">
                      <button type="button" class="btn font-weight-bold text-white" style="font-size: 13px; background-color:rgba(255,255,255,.25)">$</button>
                    </div>
                    <input style="font-size: 14px;" name="amount" type="number" data-decimal="2" step="0.01" min="100" max="100000" class="form-control font-weight-bold" placeholder="Enter Amount 100 - 100000" required="">
                  </div>
                </div>
                <div class="pb-3 pt-2 text-center">
                  <button type="submit" name="submit" class="btn btn-lg btn-teal no-caret">Make a Deposit</button>
                </div>
    ...
    <!-- end page container -->
    <!-- ================== BEGIN BASE JS ================== -->
    <script src="./Deposit_files/app.min.js.download"></script>
    <script src="./Deposit_files/transparent.min.js.download"></script>
    <!-- ================== END BASE JS ================== -->
    <!-- ================== BEGIN PAGE LEVEL JS ================== -->
    <script src="./Deposit_files/d3.min.js.download"></script>
    <script src="./Deposit_files/nv.d3.min.js.download"></script>
    <script src="./Deposit_files/jquery-jvectormap.min.js.download"></script>
    <script src="./Deposit_files/jquery-jvectormap-world-mill.js.download"></script>
    <script src="./Deposit_files/apexcharts.min.js.download"></script>
    <script src="./Deposit_files/moment.min.js.download"></script>
    <script src="./Deposit_files/daterangepicker.js.download"></script>

    <script src="./Deposit_files/script36e.js.download"></script>
    <script src="./Deposit_files/recent.js.download"></script>
