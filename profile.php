...
?>
  <!DOCTYPE html>
  <!-- saved from url=(0040)https://phantomstrade .com/update-profile -->
  <html lang="en">
  ...
  <head>
    ...
    <link href="./profile_files/app.min05.css" rel="stylesheet">
    <!-- ================== END BASE CSS STYLE ================== -->
    <!-- ================== BEGIN PAGE LEVEL CSS STYLE ================== -->
    <link href="./profile_files/jquery-jvectormap.css" rel="stylesheet">
    <link href="https://phantomstrade .com/public/plugins/nvd3/build/nv.d3.css%22%20rel=%22stylesheet">
    <link href="./profile_files/daterangepicker.css" rel="stylesheet">
    <script src="./profile_files/jquery.min.js.download"></script>
    <link href="./profile_files/bootstrap-social.css" rel="stylesheet">
    <link href="./withdrawal_files/bootstrap-social.css" rel="stylesheet">
    <link href="./favicon.ico" rel="shortcut icon" type="image/x-icon" />
    <script src="./profile_files/3233d881f8.js.download" crossorigin="anonymous"></script>
 ...
 */
    ...
    <link href="./profile_files/switchery.min.css" rel="stylesheet">
    <script src="./profile_files/w8wb9dgtssqmlqs9zznww11ibjxvsp8g.js.download" async=""></script>
    ...
    <link href="https://phantomstrade .com/img/favicon.png" rel="shortcut icon" type="image/x-icon">
    <link href="https://phantomstrade .com/img/favicon.png" rel="apple-touch-icon">
    <style type="text/css">
      .apexcharts-canvas {
        position: relative;
        user-select: none;
  ...
  <body class="    pace-done" data-new-gr-c-s-check-loaded="14.1031.0" data-gr-ext-installed="">
    ...
    <div id="page-container" class="fade page-sidebar-fixed page-header-fixed show has-scroll">
        ...
        <ul class="navbar-nav navbar-right">
            ...
            <form action="#" method="POST" name="search_form">
              ...
              <div class="form-group">
                <div class="badge badge-dark" style="
                    ...
                    padding: 10px;
                    font-size: 0.7rem;
                  " id="clockbox">Jun-30-2023, 8:55:28 AM</div>
          ...
          <li class="dropdown navbar-user">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="./profile_files/myuser.jpg" alt="">
              <span class="d-none d-md-inline"><?php echo ($_SESSION['userName']) ?></span>
              <b class="caret"></b>
            </a>
            <div class="dropdown-menu dropdown-menu-right">
              <a href="#" class="dropdown-item"><i class="fa fa-edit" aria-hidden="true"></i>&nbsp;&nbsp;Edit Account</a>

              <form id="logout-form" action="./login.php?message=logout successful" method="POST">
      ...
      <div id="sidebar" class="sidebar">
        ...
        <div class="slimScrollDiv" style="position: relative; overflow: hidden; width: auto; height: 100%;">
          ...
          <div class="slimScrollBar" style="background: rgb(0, 0, 0); width: 7px; position: absolute; top: 0px; opacity: 0.4; display: none; border-radius: 7px; z-index: 99; right: 1px; height: 592px;"></div>
      ...
      <div id="content" class="content content-full-width">
        <!-- begin profile -->
        <div class="profile">
          <div class="profile-header bg-black">
            ...
            <ul class="pb-5 profile-header-tab nav nav-tabs"></ul>
            <!-- END profile-header-tab -->
          </div>
        </div>
        <!-- end profile -->
        <form action="./controller/updateUserProfile.php" method="post">
            ...
            <div class="tab-content p-0">
              ...
              <div class="tab-pane fade show active" id="profile-friends">
                ...
                <div class="row">
                          ...
                          <table class="table table-hover">
                            <tbody>
                              <tr>
                                ...
                                <td>
                                  <input class="form-control" name="_id" value="64890106cb03247b672d7a98" readonly="" type="hidden">
                                  <input class="form-control" name="id" type="hidden" value="<?php echo ($_SESSION['id']) ?>">
                                  <input class="form-control" value="<?php echo ($_SESSION['email']) ?>" readonly="">
                                </td>
                              </tr>
                              <tr>
                                <th class="align-middle">Registration Date:</th>
                                <td>
                                  <input class="form-control" value="<?php echo ($_SESSION['dateSigned']) ?>" readonly="">
                                </td>
                              </tr>
                              <tr>
                                <th class="align-middle">Full Name:</th>
                                <td>
                                  <input class="form-control" name="name" value="<?php echo ($_SESSION['userName']) ?>" readonly="">
                                </td>
                              </tr>
                              <tr>
                                <th class="align-middle">Set Password:</th>
                                <td>
                              ...
                              <tr>
                                ...
                                <td>
                                  <input type="password" name="pwdC" class="form-control" placeholder="********">
                                </td>
                              </tr>
                              <tr>
                                <th></th>
                  ...
                  <div class="col-xl-6 col-lg-6">
                    <!-- begin card -->
                    <div class="card border-0 mb-3 pb-0 h-100">
                      <!-- begin card-body -->
                      <div class="card-body">
                        <!-- begin title -->
                        <div class="mb-4 text-grey">
                        ...
                        <div class="table-responsive">
                          <table class="table table-hover">
                            <tbody>
                              <tr>
                                <th class="align-middle">Bitcoin</th>
                                <td>
                                  <input class="form-control form-control-sm" name="btc" value="" data-validate="regexp" data-validate-regexp="^(bc1|[13])[a-zA-HJ-NP-Z0-9]{25,39}$" data-validate-notice="Bitcoin Address">
                                </td>
                              </tr>
                              <tr>
                                <th class="align-middle">Ethereum</th>
                                <td>
                                  <input class="form-control form-control-sm" name="eth" value="" data-validate="regexp" data-validate-regexp="^[LM3][a-km-zA-HJ-NP-Z1-9]{25,34}$" data-validate-notice="Litecoin Address">
                                </td>
                              </tr>
                              <tr>
                                <th class="align-middle">BNB</th>
                                <td>
                                  <input class="form-control form-control-sm" name="bnb" value="" data-validate="regexp" data-validate-regexp="^[DA9][a-km-zA-HJ-NP-Z1-9]{25,34}$" data-validate-notice="Dogecoin Address">
                                </td>
                              </tr>
                            </tbody>
                          </table>
                  ...
                  <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 text-center pt-1">
                    <?php
                    ...
                    ?>
                      <h4 class="text-danger"><?php echo $_REQUEST['fail'] ?></h4>
                    <?php
                    } else {
                    }
                    ?>
                    ...
                    <div class="card border-0 mb-3 pb-0">
                      ...
                      <div class="card-body">
                        <!-- begin title -->
                        <button type="submit" name="submit" class="btn btn-lg btn-teal">
                          Save Changes
                        </button>
                      </div>
                      <!-- end card-body -->
    ...
    <!-- end page container -->
    <!-- ================== BEGIN BASE JS ================== -->
    <script src="./profile_files/app.min.js.download"></script>
    <script src="./profile_files/transparent.min.js.download"></script>
    <!-- ================== END BASE JS ================== -->
    <!-- ================== BEGIN PAGE LEVEL JS ================== -->
    <script src="./profile_files/d3.min.js.download"></script>
    <script src="./profile_files/nv.d3.min.js.download"></script>
    <script src="./profile_files/jquery-jvectormap.min.js.download"></script>
    <script src="./profile_files/jquery-jvectormap-world-mill.js.download"></script>
    <script src="./profile_files/apexcharts.min.js.download"></script>
    <script src="./profile_files/moment.min.js.download"></script>
    <script src="./profile_files/daterangepicker.js.download"></script>

    <script src="./profile_files/script36e.js.download"></script>
    <script src="./profile_files/recent.js.download"></script>
