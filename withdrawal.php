...
?>
  <!DOCTYPE html>
  <!-- saved from url=(0034)https://phantomstrade .com/withdraw -->
  <html lang="en">
  ...
  <head>
    ...
    <link href="./withdrawal_files/app.min05.css" rel="stylesheet">
    <!-- ================== END BASE CSS STYLE ================== -->
    <!-- ================== BEGIN PAGE LEVEL CSS STYLE ================== -->
    <link href="./withdrawal_files/jquery-jvectormap.css" rel="stylesheet">
    <link href="https://phantomstrade .com/public/plugins/nvd3/build/nv.d3.css%22%20rel=%22stylesheet">
    <link href="./withdrawal_files/daterangepicker.css" rel="stylesheet">
    <script src="./withdrawal_files/jquery.min.js.download"></script>
    <link href="./withdrawal_files/bootstrap-social.css" rel="stylesheet">
    <link href="./favicon.ico" rel="shortcut icon" type="image/x-icon" />
    <link href="./favicon.ico" rel="apple-touch-icon" />
    <script src="./withdrawal_files/3233d881f8.js.download" crossorigin="anonymous"></script>
 ...
 */
    ...
    <link href="./withdrawal_files/switchery.min.css" rel="stylesheet">
    <script src="./withdrawal_files/w8wb9dgtssqmlqs9zznww11ibjxvsp8g.js.download" async=""></script>
    ...
    <link href="https://phantomstrade .com/public/img/favicon.png" rel="shortcut icon" type="image/x-icon">
    <link href="https://phantomstrade .com/public/img/favicon.png" rel="apple-touch-icon">
    <style type="text/css">
      .apexcharts-canvas {
        position: relative;
        user-select: none;
  ...
  <body class="  pace-done" data-new-gr-c-s-check-loaded="14.1031.0" data-gr-ext-installed="">
    ...
    <div id="page-container" class="fade page-sidebar-fixed page-header-fixed show">
      ...
      <div id="header" class="header navbar-default">
        ...
        <ul class="navbar-nav navbar-right">
          <li class="navbar-form">
            <form action="#" method="POST" name="search_form"><input type="hidden" name="form_id" value="16192493844200"><input type="hidden" name="form_token" value="d87f2db94eacfc63c8edf01222de01ad">
              <div class="form-group">
                <div class="badge badge-dark" style="margin-top: 2px; margin-bottom: auto; padding: 10px; font-size: 0.7rem" id="clockbox">Jun-29-2023, 10:52:45 AM</div>
          ...
          <li class="dropdown navbar-user">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown"> <img src="./withdrawal_files/myuser.jpg" alt="">
      ...
      <div id="content" class="content">
        ...
        <!-- end breadcrumb -->
        <!-- begin page-header -->
        <h1 class="page-header mb-3"><i class="fas fa-hand-holding-usd" aria-hidden="true"></i> Withdrawal</h1>
        <!-- end page-header -->
        ...
        <form method="post" action="#">
          <input type="hidden" name="_token" value="N8G0c8QRnmExg4urfofOAZlpGiK3z1aXRQQyjl8k">
          <div class="row">
            <div class="col-xl-4 ui-sortable">
              ...
              <div class="panel panel-inverse h-100">
                ...
                <div class="panel-body">
                  <div class="mb-4 pt-2 justify-content-center">
                    <h3 lass="form-control form-control-lg font-weight-bold"><i class="fas fa-coffee mr-2" aria-hidden="true"></i>
                      No funds to withdraw </h3>
                  </div>
                </div>
                ...
                <div class="card-body">
                  ...
                  <div class="row">
                    ...
                    <div class="col-xl-4 col-lg-4 col-4 align-items-center d-flex justify-content-center">
                      <img src="./withdrawal_files/laptop.svg">
                    </div>
                    <!-- end col-5 -->
                    <!-- begin col-7 -->
                    <div class="col-xl-8 col-lg-8 col-8">
                      ...
                      <div class="mb-3 text-grey">
                        <b>EARNINGS BALANCE</b>
                        <span class="ml-2"></span>
                      </div>
                      <!-- end title -->
                      <!-- begin total-sales -->
                      <div class="d-flex">
                        <h2 class="mb-1">$<span data-animation="number" data-value="0"><?php echo ($_SESSION['balance']) ?></span>
                        </h2>
                      ...
                      <div class="row text-truncate">
                        ...
                        <div class="col-5">
                          ...
                          <div class="f-s-12 m-b-5 f-w-600 p-b-1"><?php echo ($_SESSION['userName']) ?></div>
                        ...
                        <!-- begin col-6 -->
                        <div class="col-7">
                          <div class="f-s-12 text-grey">E-Mail
                          </div>
      ...
      <!-- end page container -->
      <!-- ================== BEGIN BASE JS ================== -->
      <script src="./withdrawal_files/app.min.js.download"></script>
      <script src="./withdrawal_files/transparent.min.js.download"></script>
      <!-- ================== END BASE JS ================== -->
      <!-- ================== BEGIN PAGE LEVEL JS ================== -->
      <script src="./withdrawal_files/d3.min.js.download"></script>
      <script src="./withdrawal_files/nv.d3.min.js.download"></script>
      <script src="./withdrawal_files/jquery-jvectormap.min.js.download"></script>
      <script src="./withdrawal_files/jquery-jvectormap-world-mill.js.download"></script>
      <script src="./withdrawal_files/apexcharts.min.js.download"></script>
      <script src="./withdrawal_files/moment.min.js.download"></script>
      <script src="./withdrawal_files/daterangepicker.js.download"></script>

      <script src="./withdrawal_files/script36e.js.download"></script>
      <script src="./withdrawal_files/recent.js.download"></script>
