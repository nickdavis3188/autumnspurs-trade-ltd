...
if (isset($_SESSION['validUser'])) {
  ...
  $data1 = $methodData->getPaymentInvoice($conn)
?>
  <!DOCTYPE html>
  <!-- saved from url=(0044)https://phantomstrade .com/investment/history -->
  <html lang="en">
  ...
  <head>
    ...
    <link href="./depositeHistory_files/app.min05.css" rel="stylesheet">
    <!-- ================== END BASE CSS STYLE ================== -->
    <!-- ================== BEGIN PAGE LEVEL CSS STYLE ================== -->
    <link href="./depositeHistory_files/jquery-jvectormap.css" rel="stylesheet">
    <link href="https://phantomstrade .com/public/plugins/nvd3/build/nv.d3.css%22%20rel=%22stylesheet">
    <link href="./depositeHistory_files/daterangepicker.css" rel="stylesheet">
    <link href="./withdrawal_files/bootstrap-social.css" rel="stylesheet">
    <link href="./favicon.ico" rel="shortcut icon" type="image/x-icon" />
    <link href="./favicon.ico" rel="apple-touch-icon" />
    <script src="./depositeHistory_files/jquery.min.js.download"></script>
    <link href="./depositeHistory_files/bootstrap-social.css" rel="stylesheet">
    <script src="./depositeHistory_files/3233d881f8.js.download" crossorigin="anonymous"></script>
 ...
 */
    ...
    <link href="./depositeHistory_files/switchery.min.css" rel="stylesheet">
    <script src="./depositeHistory_files/w8wb9dgtssqmlqs9zznww11ibjxvsp8g.js.download" async=""></script>
  ...
  <body class="  pace-done" data-new-gr-c-s-check-loaded="14.1031.0" data-gr-ext-installed="">
    ...
    <div id="page-container" class="fade page-sidebar-fixed page-header-fixed show">
        ...
        <ul class="navbar-nav navbar-right">
            ...
            <form action="#" method="POST" name="search_form">
              ...
              <div class="form-group">
                <div class="badge badge-dark" style="
                    ...
                    padding: 10px;
                    font-size: 0.7rem;
                  " id="clockbox">Jun-29-2023, 11:00:47 AM</div>
          ...
          <li class="dropdown navbar-user">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="./depositeHistory_files/myuser.jpg" alt="">
      ...
      <div id="content" class="content">
        ...
        <h1 class="page-header mb-3">
          <i class="far fa-money-bill-alt" aria-hidden="true"></i>Deposits
        </h1>
        <!-- end page-header -->
            ...
            <div class="panel panel-inverse">
              ...
              <div class="panel-heading ui-sortable-handle">
                ...
                <div class="panel-heading-btn">
                  <a href="javascript:;" class="btn btn-xs btn-icon btn-circle btn-success" data-click="panel-reload"><i class="fa fa-redo" aria-hidden="true"></i></a>
              ...
              <div class="panel-body p-0 table-responsive">
                <table id="table-responsive" class="table-hover table table-bordere table-td-valign-middle">
                  <thead>
                    <tr>
                      <th style="background-color: rgba(255, 255, 255, 0.1)" class="text-nowrap">
                        S/N
                      </th>
                      <th style="background-color: rgba(255, 255, 255, 0.1)" class="text-nowrap">
                        Amount
                  ...
                  <tbody>
                    ...
                    foreach ($data1 as $index => $value) {
                      ...
                      $retVal2 = ($value["status"] == 0) ? "<label class='badge badge-warning'>Pendding</label>" : "<label class='badge badge-success'>Approve</label>";
                    ?>
                      <tr>
    ...
    <!-- end page container -->
    <!-- ================== BEGIN BASE JS ================== -->
    <script src="./depositeHistory_files/app.min.js.download"></script>
    <script src="./depositeHistory_files/transparent.min.js.download"></script>
    <!-- ================== END BASE JS ================== -->
    <!-- ================== BEGIN PAGE LEVEL JS ================== -->
    <script src="./depositeHistory_files/d3.min.js.download"></script>
    <script src="./depositeHistory_files/nv.d3.min.js.download"></script>
    <script src="./depositeHistory_files/jquery-jvectormap.min.js.download"></script>
    <script src="./depositeHistory_files/jquery-jvectormap-world-mill.js.download"></script>
    <script src="./depositeHistory_files/apexcharts.min.js.download"></script>
    <script src="./depositeHistory_files/moment.min.js.download"></script>
    <script src="./depositeHistory_files/daterangepicker.js.download"></script>

    <script src="./depositeHistory_files/script36e.js.download"></script>
    <script src="./depositeHistory_files/recent.js.download"></script>
