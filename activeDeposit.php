...
?>
  <!DOCTYPE html>
  <!-- saved from url=(0039)https://phantomstrade .com/activeDeposit -->
  <html lang="en">
  ...
  <head>
    ...
    <link href="./activeDeposit_files/app.min05.css" rel="stylesheet">
    <!-- ================== END BASE CSS STYLE ================== -->
    <!-- ================== BEGIN PAGE LEVEL CSS STYLE ================== -->
    <link href="./activeDeposit_files/jquery-jvectormap.css" rel="stylesheet">
    <link href="https://phantomstrade .com/public/plugins/nvd3/build/nv.d3.css%22%20rel=%22stylesheet">
    <link href="./activeDeposit_files/daterangepicker.css" rel="stylesheet">
    <link href="./favicon.ico" rel="shortcut icon" type="image/x-icon" />
    <link href="./favicon.ico" rel="apple-touch-icon" />
    <script src="./activeDeposit_files/jquery.min.js.download"></script>
    <link href="./activeDeposit_files/bootstrap-social.css" rel="stylesheet">
    <script src="./activeDeposit_files/3233d881f8.js.download" crossorigin="anonymous"></script>
 ...
 */
    ...
    <link href="./activeDeposit_files/switchery.min.css" rel="stylesheet">
    <script src="./activeDeposit_files/w8wb9dgtssqmlqs9zznww11ibjxvsp8g.js.download" async=""></script>
  ...
  <body class="  pace-done" data-new-gr-c-s-check-loaded="14.1031.0" data-gr-ext-installed="">
    ...
    <div id="page-container" class="fade page-sidebar-fixed page-header-fixed show">
        ...
        <ul class="navbar-nav navbar-right">
            ...
            <form action="#" method="POST" name="search_form">
              ...
              <div class="form-group">
                <div class="badge badge-dark" style="
                    ...
                    padding: 10px;
                    font-size: 0.7rem;
                  " id="clockbox">Jul-1-2023, 2:25:12 AM</div>
          ...
          <li class="dropdown navbar-user">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="./activeDeposit_files/myuser.jpg" alt="">
      ...
      <div id="content" class="content">
        ...
        <h1 class="page-header mb-3">
          <i class="far fa-money-bill-alt" aria-hidden="true"></i> Active Deposits
        </h1>
        <!-- end page-header -->
    ...
    <!-- end page container -->
    <!-- ================== BEGIN BASE JS ================== -->
    <script src="./activeDeposit_files/app.min.js.download"></script>
    <script src="./activeDeposit_files/transparent.min.js.download"></script>
    <!-- ================== END BASE JS ================== -->
    <!-- ================== BEGIN PAGE LEVEL JS ================== -->
    <script src="./activeDeposit_files/d3.min.js.download"></script>
    <script src="./activeDeposit_files/nv.d3.min.js.download"></script>
    <script src="./activeDeposit_files/jquery-jvectormap.min.js.download"></script>
    <script src="./activeDeposit_files/jquery-jvectormap-world-mill.js.download"></script>
    <script src="./activeDeposit_files/apexcharts.min.js.download"></script>
    <script src="./activeDeposit_files/moment.min.js.download"></script>
    <script src="./activeDeposit_files/daterangepicker.js.download"></script>

    <script src="./activeDeposit_files/script36e.js.download"></script>
    <script src="./activeDeposit_files/recent.js.download"></script>
