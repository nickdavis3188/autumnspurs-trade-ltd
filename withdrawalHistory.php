...
?>
  <!DOCTYPE html>
  <!-- saved from url=(0042)https://phantomstrade .com/withdraw/history -->
  <html lang="en">
  ...
  <head>
    ...
    <link href="./withdrawalHistory_files/app.min05.css" rel="stylesheet">
    <!-- ================== END BASE CSS STYLE ================== -->
    <!-- ================== BEGIN PAGE LEVEL CSS STYLE ================== -->
    <link href="./withdrawalHistory_files/jquery-jvectormap.css" rel="stylesheet">
    <link href="https://phantomstrade .com/public/plugins/nvd3/build/nv.d3.css%22%20rel=%22stylesheet">
    <link href="./withdrawalHistory_files/daterangepicker.css" rel="stylesheet">
    <script src="./withdrawalHistory_files/jquery.min.js.download"></script>
    <link href="./favicon.ico" rel="shortcut icon" type="image/x-icon" />
    <link href="./favicon.ico" rel="apple-touch-icon" />
    <link href="./withdrawalHistory_files/bootstrap-social.css" rel="stylesheet">
    <script src="./withdrawalHistory_files/3233d881f8.js.download" crossorigin="anonymous"></script>
 ...
 */
    ...
    <link href="./withdrawalHistory_files/switchery.min.css" rel="stylesheet">
    <script src="./withdrawalHistory_files/w8wb9dgtssqmlqs9zznww11ibjxvsp8g.js.download" async=""></script>
    ...
    <!-- <link href="https://phantomstrade .com/withdraw/img/favicon.png" rel="shortcut icon" type="image/x-icon">
    <link href="https://phantomstrade .com/withdraw/img/favicon.png" rel="apple-touch-icon"> -->
    <style type="text/css">
      .apexcharts-canvas {
        position: relative;
        user-select: none;
  ...
  <body class="  pace-done" data-new-gr-c-s-check-loaded="14.1031.0" data-gr-ext-installed="">
    ...
    <div id="page-container" class="fade page-sidebar-fixed page-header-fixed show">
        ...
        <ul class="navbar-nav navbar-right">
            ...
            <form action="#" method="POST" name="search_form">
              ...
              <div class="form-group">
                <div class="badge badge-dark" style="
                    ...
                    padding: 10px;
                    font-size: 0.7rem;
                  " id="clockbox">Jun-29-2023, 11:00:13 AM</div>
          ...
          <li class="dropdown navbar-user">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="./withdrawalHistory_files/myuser.jpg" alt="">
      ...
      <div id="content" class="content">
        ...
        <h1 class="page-header mb-3">
          <i class="far fa-money-bill-alt" aria-hidden="true"></i>Withdrawal History
        </h1>
        <!-- end page-header -->
                ...
                <table id="table-responsive" class="table-hover table table-bordere table-td-valign-middle">
                  <thead>
                    <tr>
                      ...
                      <th style="background-color: rgba(255, 255, 255, 0.1)" class="text-center">
                        Status
                      </th>
                      <th style="background-color: rgba(255, 255, 255, 0.1)" class="text-center">
                        Date
    ...
    <!-- end page container -->
    <!-- ================== BEGIN BASE JS ================== -->
    <script src="./withdrawalHistory_files/app.min.js.download"></script>
    <script src="./withdrawalHistory_files/transparent.min.js.download"></script>
    <!-- ================== END BASE JS ================== -->
    <!-- ================== BEGIN PAGE LEVEL JS ================== -->
    <script src="./withdrawalHistory_files/d3.min.js.download"></script>
    <script src="./withdrawalHistory_files/nv.d3.min.js.download"></script>
    <script src="./withdrawalHistory_files/jquery-jvectormap.min.js.download"></script>
    <script src="./withdrawalHistory_files/jquery-jvectormap-world-mill.js.download"></script>
    <script src="./withdrawalHistory_files/apexcharts.min.js.download"></script>
    <script src="./withdrawalHistory_files/moment.min.js.download"></script>
    <script src="./withdrawalHistory_files/daterangepicker.js.download"></script>

    <script src="./withdrawalHistory_files/script36e.js.download"></script>
    <script src="./withdrawalHistory_files/recent.js.download"></script>
