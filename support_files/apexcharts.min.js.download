...
!(function (t, e) {
          ...
          },
          {
            ...
            value: function (t, e, i, a, s, r) {
              ...
              i || (i = t.attr("pathFrom")),
                ...
                t
                  .plot(i)
                  .animate(1, o.globals.easing, r)
                  .plot(i)
                  .animate(s, o.globals.easing, r)
                  .plot(a)
                  .afterAll(function () {
                    g.isNumber(e)
                      ? e ===
                      ...
                      : o.globals.shouldAnimate && n.animationCompleted(t),
                      n.showDelayedElements();
                  });
            },
          },
        ]),
          ...
          [
            ...
            },
            {
              ...
              value: function (t) {
                ...
                var X = { el: I, j: i, pathFrom: s, pathTo: r, strokeWidth: l };
                return (
            ...
            value: function (t, e, i) {
              ...
              if (this.annoCtx.invertAxis) {
                ...
                (a =
                  ...
                  (t.y - r.globals.minYArr[t.yAxisIndex]) /
                    (r.globals.yRange[t.yAxisIndex] / r.globals.gridHeight)),
                  r.config.yaxis[t.yAxisIndex] &&
                    r.config.yaxis[t.yAxisIndex].reversed &&
                    (a =
                      (t.y - r.globals.minYArr[t.yAxisIndex]) /
                      (r.globals.yRange[t.yAxisIndex] / r.globals.gridHeight));
              var h = t.label.text;
              if (null === t.y2) {
                ...
                if (this.annoCtx.invertAxis) {
                  var d = r.globals.labels.indexOf(t.y2),
                    g = r.globals.dom.baseEl.querySelector(
                      ".apexcharts-yaxis-texts-g text:nth-child(" +
                        (d + 1) +
                        ")"
                    );
                  g && (s = parseFloat(g.getAttribute("y")));
                } else
                  (s =
                    r.globals.gridHeight -
                    (t.y2 - r.globals.minYArr[t.yAxisIndex]) /
                      (r.globals.yRange[t.yAxisIndex] / r.globals.gridHeight)),
                    r.config.yaxis[t.yAxisIndex] &&
                      r.config.yaxis[t.yAxisIndex].reversed &&
                      (s =
                        (t.y2 - r.globals.minYArr[t.yAxisIndex]) /
                        (r.globals.yRange[t.yAxisIndex] /
                          r.globals.gridHeight));
                if (s > a) {
                  var u = a;
                  (a = s), (s = u);
              ...
              var p = "right" === t.label.position ? r.globals.gridWidth : 0,
                x = this.annoCtx.graphics.drawText({
                  x: p + t.label.offsetX,
    ...
    C = (function () {
      function t(i) {
        e(this, t),
          ...
          (this.pointsAnnotations = new m(this)),
          ...
          },
          {
            ...
            value: function (t) {
              ...
              e.globals.memory.methodsToExec.map(function (t, i) {
                ...
                (i = g.listToArray(i)).forEach(function (t) {
          ...
          },
          {
            ...
            value: function (t) {
              ...
              var u = o.globals.dom.baseEl.querySelector(
                ...
                f = this.helpers.addBackgroundToAnno(u, d);
              return (
                f && l.insertBefore(f.node, u),
                i &&
                  o.globals.memory.methodsToExec.push({
                    context: n,
                    id: d.id ? d.id : g.randomId(),
                    method: r,
                    label: "addAnnotation",
                    params: e,
                  }),
          ...
          },
          {
            ...
            value: function (t, e) {
              var i =
                ...
                s = ["\0"].concat(d(a.months)),
                r = ["\x01"].concat(d(a.shortMonths)),
                n = ["\x02"].concat(d(a.days)),
                o = ["\x03"].concat(d(a.shortDays));
              function l(t, e) {
                var i = t + "";
              ...
              var p = t.getUTCMinutes();
              e = (e = e.replace(/(^|[^\\])mm+/g, "$1" + l(p))).replace(
                /(^|[^\\])m/g,
                "$1" + p
              );
              var x = t.getUTCSeconds();
              e = (e = e.replace(/(^|[^\\])ss+/g, "$1" + l(x))).replace(
                /(^|[^\\])s/g,
                "$1" + x
              );
              var b = t.getUTCMilliseconds();
          ...
          },
          {
            ...
            value: function (t, e) {
              ...
              var a = new Date(t).getUTCFullYear(),
                s = new Date(e).getUTCFullYear(),
                r = new Date(t).getUTCMonth(),
                n = new Date(e).getUTCMonth(),
                o = new Date(t).getUTCDate(),
                l = new Date(e).getUTCDate(),
                h = new Date(t).getUTCHours(),
                c = new Date(e).getUTCHours();
              return {
        ...
        a(t, [
          {
            ...
            value: function (t, e, i) {
              ...
              if (
                ...
                return new L(this.ctx).formatDate(
                  new Date(e),
                ...
                t.config.yaxis.forEach(function (e, i) {
                  void 0 !== e.labels.formatter
                    ...
                    : (t.globals.yLabelFormatters[i] = function (a) {
                        return t.globals.xyCharts && g.isNumber(a)
        ...
        a(t, [
          {
            ...
            value: function (t, e, i, a) {
              var s,
                ...
                n = this.w,
                o = void 0 === t[a] ? "" : t[a],
                l = n.globals.xLabelFormatter,
                h = n.config.xaxis.labels.formatter,
                c = !1,
                d = new P(this.ctx),
                g = o;
              (s = d.xLabelFormat(l, o, g)),
              ...
              return (
                e.length > 0
                  ? ((c = u(e[a].unit)), (i = e[a].position), (s = e[a].value))
        ...
        a(t, [
          {
            ...
            value: function () {
              ...
              a.add(s);
              for (
                var r = e.globals.padHorizontal, n = [], o = 0;
                o < this.xaxisLabels.length;
                o++
              )
                n.push(this.xaxisLabels[o]);
              r = e.globals.isXNumeric
                ? r +
                  (t = e.globals.gridWidth / (n.length - 1)) / 2 +
                  e.config.xaxis.labels.offsetX
                : r +
                  (t = e.globals.gridWidth / n.length) +
                  e.config.xaxis.labels.offsetX;
              var l = n.length;
              if (e.config.xaxis.labels.show)
                for (var h = 0; h <= l - 1; h++) {
                  ...
                  var u = i.drawText({
                    x: d.x,
                    y: this.offY + e.config.xaxis.labels.offsetY + g,
                    text: "",
                    textAnchor: "middle",
                  ...
                  if (0 === h) {
                    ...
                    (e.globals.skipFirstTimelinelabel ||
                      (d.x + f.width / x > e.globals.dom.elGraphical.x() &&
                        d.x <= 0)) &&
                      (d.text = "");
                  }
                  if (h === l - 1) {
                    ...
                    (e.globals.skipLastTimelinelabel ||
                      b.width / 2 + d.x >
                        e.globals.gridWidth + e.globals.x2SpaceAvailable ||
                      d.x > e.globals.gridWidth) &&
                      (d.text = "");
                  }
                  s.add(u), i.addTspan(u, d.text, this.xaxisFontFamily);
                  var v = document.createElementNS(e.globals.SVGNS, "title");
                  (v.textContent = d.text), u.node.appendChild(v), (r += t);
                }
          ...
          },
          {
            ...
            value: function (t) {
              ...
              this.isCategoryBarHorizontal &&
                ...
                (m = a.globals.gridWidth);
              var y = a.config.xaxis.axisBorder;
              if (y.show) {
                var w = s.drawLine(
                  a.globals.padHorizontal + y.offsetX + m,
                  1 + y.offsetY,
                  a.globals.padHorizontal + y.offsetX + m,
                  a.globals.gridHeight + y.offsetY,
                  y.color,
                  0
                );
                n.add(w);
          ...
          },
          {
            ...
            value: function () {
              ...
              if (t.globals.rotateXLabels || t.config.xaxis.labels.rotateAlways)
                ...
                for (
                  var h = t.globals.gridWidth / (t.globals.labels.length + 1),
                    c = 0;
                  c < a.length;
                  c++
                ) {
              ...
              if (e.config.yaxis[t].labels.show)
                for (var u = o; u >= 0; u--) {
                  ...
                  if (
                    ...
                    var v = i.rotateAroundCenter(g.node),
            ...
            value: function (t) {
              ...
              if (w.show) {
                ...
                "bar" === e.config.chart.type &&
                  ...
                  (k -= 15);
                var A = i.drawLine(
                  e.globals.padHorizontal + k + w.offsetX,
                  this.xAxisoffX,
                  e.globals.gridWidth,
                  this.xAxisoffX,
                  w.color,
  ...
  var D,
        ...
        a(i, [
          {
            ...
            value: function () {
              ...
              if (e && "object" === t(e)) {
                ...
                (n =
                  ...
                  [
                    ...
                    "radar",
                    "radialBar",
                  ].indexOf(e.chart.type)
                    ? a[e.chart.type]()
                    : a.line()),
                  e.chart.brush && e.chart.brush.enabled && (n = a.brush(n)),
                  e.chart.stacked &&
                ...
                var o = X.checkComboSeries(e.series);
                ("line" !== e.chart.type &&
                  "area" !== e.chart.type &&
              ...
              var l = g.extend(r, window.Apex);
              return (s = g.extend(l, e)), (s = this.handleUserInputErrors(s));
            },
          },
          {
            key: "extendYAxis",
            value: function (t) {
              return (
                ...
                t.yaxis.constructor !== Array
                  ? (t.yaxis = [g.extend(Y, t.yaxis)])
                  : (t.yaxis = g.extendArray(t.yaxis, Y)),
                t
              );
            },
          },
            ...
            value: function (t, e, i, a, s, r, n) {
              ...
              if (
                (o.config.series[l].data[r] &&
                  ...
                  (v = o.config.series[l].data[r].fillColor),
                m.attr({
                  cx: t,
                  cy: e,
                  fill: v,
              ...
              if (this.initialAnim && !o.globals.dataChanged) {
                ...
                o.globals.resized || (w = o.config.chart.animations.speed),
                  h.animateCircleRadius(m, 0, a, w, o.globals.easing);
              }
            ...
            value: function (t) {
              ...
              if (
                ...
                if (
                  ...
                  if (
                    (v.attr({ class: "apexcharts-datalabel", cx: a, cy: s }),
          ...
          },
          {
            ...
            value: function () {
              for (
                ...
                i.insertAdjacentElement("beforeEnd", e[a]);
            },
          },
        ]),
        t
        ...
        a(t, [
          {
            ...
            value: function (t) {
              ...
              f.globals.isXNumeric &&
                ...
                ((v = e + parseFloat(c * (g + 1))),
                (m = i + parseFloat(h * (g + 1)) - b));
              var y = e,
                w = i,
                k = {},
          ...
          },
          {
            ...
            value: function (t) {
              ...
              if (c.enabled && !v) {
                ...
                var m = "";
                void 0 !== a &&
                  (m = x(a, { seriesIndex: s, dataPointIndex: r, w: d })),
                ...
                if (
                  ...
                  h < f.getTextRects(m, parseFloat(c.style.fontSize)).width &&
                    (m = "");
                d.config.chart.stacked &&
                  this.barCtx.barOptions.dataLabels.hideOverflowingLabels &&
                  (this.barCtx.isHorizontal
                    ? (((h =
                        d.globals.series[s][r] /
          ...
          },
          {
            ...
            value: function () {
              ...
              return (
                ...
                this.barCtx.isHorizontal
                  ? ((s =
                      (i = l.globals.gridHeight / h) / this.barCtx.seriesLen),
                  ...
                  : ((r =
                    ...
                    l.globals.isXNumeric &&
                      (l.globals.minXDiff &&
                        l.globals.minXDiff / this.barCtx.xRatio > 0 &&
                        (a = l.globals.minXDiff / this.barCtx.xRatio),
                      (r =
              ...
              for (var o = 0, l = 0; o < t.length; o++, l++) {
                ...
                for (
                  ...
                  var L = this.barHelpers.getStrokeWidth(o, C, m),
                    P = null,
                    z = {
                      indexes: { i: o, j: C, realIndex: m, bc: l },
                      x: f,
                      y: x,
                      strokeWidth: L,
                      elSeries: y,
                  ...
                  this.isHorizontal
                    ...
                    C > 0 && v.push(f + k / 2),
                    b.push(x);
                  var T = this.barHelpers.getPathFillColor(t, o, C, m);
                  this.renderSeries({
                    realIndex: m,
                    pathFill: T,
                    j: C,
          ...
          },
          {
            ...
            value: function (t) {
              ...
              L.attr(
                ...
                h.add(L);
              var P = new tt(this).handleBarDataLabels({
                x: c,
                y: d,
                y1: g,
                y2: f,
        ...
        a(i, [
          {
            ...
            value: function (t, e) {
              var i = this.w;
              (this.graphics = new p(this.ctx)),
                (this.bar = new it(this.ctx, this.xyRatios));
              var a = new X(this.ctx, i);
              (t = a.getLogSeries(t)),
              ...
              for (
                ...
                for (var C = 0; C < i.globals.dataPoints; C++) {
                  var L = this.barHelpers.getStrokeWidth(h, C, m),
                    P = {
                      indexes: { i: h, j: C, realIndex: m, bc: c },
                      strokeWidth: L,
                      x: o,
                      y: l,
                      elSeries: y,
                  ...
                  this.isHorizontal
                    ...
                    b.push(o),
                    v.push(l);
                  var T = this.barHelpers.getPathFillColor(t, h, C, m);
                  y = this.renderSeries({
                    realIndex: m,
                    pathFill: T,
                    j: C,
          ...
          },
          {
            ...
            value: function (t) {
              ...
              for (var p, x = i, b = 0, v = 0; v < this.prevYF.length; v++)
                b += this.prevYF[v][d];
              if (
            ...
            value: function (t) {
              ...
              if ("true" !== s.attr("data:pieClicked")) {
                ...
                (e = this.getPiePath({
                  ...
                  360 !== l &&
                    s.plot(e).animate(1).plot(r).animate(100).plot(e);
              } else {
          ...
          },
          {
            ...
            value: function (t) {
              ...
              return "donut" === r.config.chart.type
                ...
                ? [].concat(v, ["L", e.centerX, e.centerY, "L", c, d]).join(" ")
                : [].concat(v).join(" ");
            },
          },
          {
              ...
              if (
                ...
                t.forEach(function (t, o) {
                  ...
                  t.forEach(function (t, a) {
                    var s = new J(e.ctx).getMarkerConfig(
                        "apexcharts-marker",
                        o,
                        a
                      ),
              ...
              for (
                ...
                e.globals.dataChanged &&
                  ...
                  (C =
                    Math.round(
                      (this.totalAngle *
                        g.negToZero(e.globals.previousPaths[v])) /
                        100
                    ) + k)),
            ...
            value: function (t, e) {
              ...
              for (
                ...
                for (
                  ...
                  if (
                    ((u = m.yDivision), (b = m.barHeight), this.isHorizontal)
                  ) {
                    L = d + b * this.visibleI;
        ...
        a(t, [
          ...
          },
          {
            ...
            value: function (t) {
              var e = this.w,
                ...
                r = this.getyAxisTitleCoords(),
                n = this.getxAxisTitleCoords();
              (e.globals.yLabelsCoords = []),
                ...
                this.conditionalChecksForAxisCoords(s, n),
              ...
              this.setGridXPosForDualYAxis(r, a),
                new E(this.ctx).setYAxisXPosition(a, r);
            },
          },
          {
            ...
            value: function (t) {
              ...
              var r = 10,
                n = 0;
              if (
                ("pie" === a.chart.type || "donut" === a.chart.type
                  ? ((r += a.plotOptions.pie.offsetY),
                    (n += a.plotOptions.pie.offsetX))
                  : "radialBar" === a.chart.type &&
                    ((r += a.plotOptions.radialBar.offsetY),
                    (n += a.plotOptions.radialBar.offsetX)),
                !a.legend.show || a.legend.floating)
              )
                return (
                  (i.gridHeight = i.svgHeight - i.goldenPadding),
              ...
              switch (a.legend.position) {
                case "bottom":
                  (i.gridHeight = i.svgHeight - t.height - i.goldenPadding),
                    (i.gridWidth = i.gridHeight),
                    (i.translateY = r - 20),
                ...
                case "top":
                  (i.gridHeight = i.svgHeight - t.height - i.goldenPadding),
                    (i.gridWidth = i.gridHeight),
                    (i.translateY = t.height + r + 10),
                    (i.translateX = n + (i.svgWidth - i.gridWidth) / 2);
                  break;
                case "left":
                  (i.gridWidth = i.svgWidth - t.width - s),
                    (i.gridHeight =
                      "auto" !== a.chart.height ? i.svgHeight : i.gridWidth),
                    (i.translateY = r),
          ...
          },
          {
            ...
            value: function (t) {
              ...
              var o = i.config.yaxis[0].opposite && i.globals.isBarHorizontal,
                l = function (t, i) {
                  (function (t) {
                    ...
                    ("datetime" !== r &&
                      s.grid.padding.left < n / 2 - e.yAxisWidthLeft &&
                      (e.xPadLeft = n / 2 + 1),
                    (function (t) {
              ...
              s.yaxis.forEach(function (t, i) {
                o
                  ? (s.grid.padding.left < n && (e.xPadLeft = n / 2 + 1),
                    (e.xPadRight = n / 2 + 1))
                  : l(t, i);
              });
            },
          },
          {
            ...
            value: function () {
              ...
              (e.gridHeight = e.gridHeight - s.height - r.height - i),
                (e.translateY = e.translateY + s.height + r.height + i);
            },
          },
          {
              ...
              return (
                ...
                t.globals.isBarHorizontal &&
                  (e =
                    ...
                    15),
                (this.yAxisWidthLeft = i),
                (this.yAxisWidthRight = a),
                e
              );
            },
          },
          ...
          },
          {
            ...
            value: function () {
              ...
              if (e.globals.timescaleLabels.length > 0) {
                ...
                var o = n;
                n = new P(this.ctx).xLabelFormat(r, n, o);
                var l = new p(this.ctx),
                  h = l.getTextRects(n, e.config.xaxis.labels.style.fontSize);
                    ...
                    if (
                      ...
                      (a = 0),
                        (o = n(
                          ...
                          { seriesIndex: r, dataPointIndex: -1, w: e }
                        ));
            ...
            value: function () {
              ...
              return (
                ...
                ("left" !== t.config.legend.position &&
                  ...
                  (1.5 * this.lgRect.width > t.globals.svgWidth &&
                    (this.lgRect.width = t.globals.svgWidth / 1.5)),
                this.lgRect
              );
            },
          },
          ...
          },
          {
            ...
            value: function () {
              ...
              if (
                ...
                n.node.setAttribute("class", "apexcharts-title-text"),
              ...
              for (
                ...
                (k.background = a[o]),
                  ...
                  (k.height = Array.isArray(b)
                    ? parseFloat(b[o]) + "px"
                    : parseFloat(b) + "px"),
                  (k.width = Array.isArray(v)
                    ? parseFloat(v[o]) + "px"
                    : parseFloat(v) + "px"),
                  (k.left = Array.isArray(f) ? f[o] : f),
                  (k.top = Array.isArray(x) ? x[o] : x),
                  (k.borderWidth = Array.isArray(m) ? m[o] : m),
                  ...
                  (h || c) && u.classList.add("inactive-legend");
                var A = document.createElement("div"),
                  S = document.createElement("span");
                S.classList.add("apexcharts-legend-text"), (S.innerHTML = l);
                ...
                t.config.legend.showForNullSeries ||
                  ...
                  (h || c) && A.classList.add("inactive-legend"),
          ...
          },
          {
            ...
            value: function (t, e) {
              ...
              (a.style.position = "absolute"),
                ...
                a.style.width &&
                  (a.style.width = parseInt(i.config.legend.width, 10) + "px"),
                a.style.height &&
                  (a.style.height =
                    parseInt(i.config.legend.height, 10) + "px");
            },
          },
          {
              ...
              if ("heatmap" === e.config.chart.type || this.isBarsDistributed) {
                if (i) {
                  ...
                  this.ctx.fireEvent("legendHover", [this.ctx, a, this.w]),
                    new gt(this.ctx).highlightRangeInSeries(t, t.target);
                }
              } else
                !t.target.classList.contains("inactive-legend") &&
                  i &&
                  new gt(this.ctx).toggleSeriesOnHover(t, t.target);
            },
          },
          {
            key: "onLegendClick",
              ...
              if (i.globals.axisCharts || "radialBar" === i.config.chart.type) {
                ...
                if ("pie" === c || "donut" === c) {
                  var d = i.config.plotOptions.pie.donut.labels,
                    g = new p(this.ctx),
                    u = new ot(this.ctx);
                  g.pathMouseDown(h.members[0], null),
                    u.printDataLabelsInner(h.members[0].node, d);
                }
                h.fire("click");
              }
            },
        ...
        a(t, [
            ...
            value: function (t, e, i) {
              ...
              for (
                var u = this.xyRatios.zRatio,
                  f = this.xyRatios.xRatio,
                  x = this.xyRatios.baseLineY,
                  b = [],
                  v = [],
                  m = 0,
                  y = 0;
                ...
                if (
                  ...
                  ("gradient" === a.config.fill.type ||
                    "gradient" === a.config.fill.type[y]) &&
                  c.seriesHaveSameValues(y)
                ) {
                  var w = t[y].slice();
                  (w[w.length - 1] = w[w.length - 1] + 1e-6), (t[y] = w);
                }
                var k = a.globals.gridWidth / a.globals.dataPoints,
                  A = a.globals.comboCharts ? i[y] : y,
                  S = Array.isArray(a.config.stroke.width)
                    ? a.config.stroke.width[A]
                    : a.config.stroke.width;
                d.length > 1 && (this.yaxisIndex = A),
                  (this.isReversed =
                ...
                var C = [],
                  ...
                  P =
                    ...
                    (this.isReversed ? 2 * x[this.yaxisIndex] : 0),
                  z = P;
                P > a.globals.gridHeight && (z = a.globals.gridHeight),
                  (m = k / 2);
                var T = a.globals.padHorizontal + m,
                  E = 1;
                a.globals.isXNumeric &&
                  a.globals.seriesX.length > 0 &&
                  (T = (a.globals.seriesX[A][0] - a.globals.minX) / f),
                  L.push(T);
                var I = void 0,
                  M = void 0,
                  Y = void 0,
                  ...
                  H = s.group({
                    class: "apexcharts-series",
                    seriesName: g.escapeString(a.globals.seriesNames[A]),
                  }),
                  O = s.group({ class: "apexcharts-series-markers-wrap" }),
                  N = s.group({ class: "apexcharts-datalabels" });
                this.ctx.series.addCollapsedClassToSeries(H, A);
                var W = t[y].length === a.globals.dataPoints;
                H.attr({
                ...
                if (
                  ...
                  for (var U = 0; U < t[y].length; U++)
                    if (null !== t[y][U]) {
                      (G = k * U),
                        (_ = P - t[y][U] / d[this.yaxisIndex]),
                        (I = s.move(G, _)),
                        (M = s.move(G, z));
                      break;
                    }
                } else (I = s.move(G, _)), (M = s.move(G, z) + s.line(G, _));
                if (
                  ((Y = s.move(-1, P) + s.line(-1, P)),
                  (R = s.move(-1, P) + s.line(-1, P)),
                  a.globals.previousPaths.length > 0)
                ) {
                  var q = this.checkPreviousPaths({
                    pathFromLine: Y,
                    pathFromArea: R,
                    realIndex: A,
                  });
                  (Y = q.pathFromLine), (R = q.pathFromArea);
                }
                for (
                  var Z =
                  ...
                  var tt = void 0 === t[y][Q + 1] || null === t[y][Q + 1];
                  if (a.globals.isXNumeric) {
                    var et = a.globals.seriesX[A][Q + 1];
                    void 0 === a.globals.seriesX[A][Q + 1] &&
                      (et = a.globals.seriesX[A][Z - 1]),
                      (T = (et - a.globals.minX) / f);
                  } else T += k;
                  var it = g.isNumber(a.globals.minYArr[A])
                    ? a.globals.minYArr[A]
                    : a.globals.minY;
                  (j =
                    ...
                    (E = tt
                      ? j -
                        it / d[this.yaxisIndex] +
                        2 * (this.isReversed ? it / d[this.yaxisIndex] : 0)
                      : j -
                        t[y][Q + 1] / d[this.yaxisIndex] +
                        2 *
                          (this.isReversed
                            ? t[y][Q + 1] / d[this.yaxisIndex]
                            : 0)),
                  ...
                  if (this.pointsChart)
                    ...
                    var rt = new J(this.ctx);
                    a.globals.dataPoints > 1 && O.node.classList.add("hidden");
                    var nt = rt.plotChartMarkers(st, A, Q + 1);
                    null !== nt && O.add(nt);
                  }
                  var ot = o.drawDataLabel(st, A, Q + 1, null, S);
                  null !== ot && N.add(ot);
                }
                v.push(C),
                  (a.globals.seriesXvalues[A] = L),
                  (a.globals.seriesYvalues[A] = C),
                  this.pointsChart ||
                    a.globals.delayedElements.push({ el: O.node, index: A });
                var lt = {
                  i: y,
                  realIndex: A,
                  animationDelay: y,
                ...
                if ("area" === l)
                  for (
                    var ht = r.fillPath({ seriesNumber: A }), ct = 0;
                    ct < F.length;
                    ct++
                  ) {
                    var dt = s.renderPaths(
                      n({}, lt, {
                        pathFrom: R,
                        pathTo: F[ct],
                        stroke: "none",
                ...
                H.add(O), H.add(N), b.push(H);
              }
              for (var pt = b.length; pt > 0; pt--) h.add(b[pt - 1]);
              return h;
            },
          },
          {
                      ...
                      (null !== e[i][a + 1]
                        ? ((c =
                          ...
                          (d =
                            ...
                            b.line(n, h) +
                            "z"))
                        : ((c = b.move(n, o)), (d = b.move(n, o) + "z"))),
                    g.push(c),
                    u.push(d))
                  : ((c += b.curve(n + m, o, s - m, r, s, r)),
                    (d += b.curve(n + m, o, s - m, r, s, r))),
                  (n = s),
                  (o = r),
                  a === e[i].length - 2 &&
                    ((d = d + b.curve(n, o, s, r, s, h) + b.move(s, r) + "z"),
                    x.globals.hasNullValues || (g.push(c), u.push(d)));
              } else
                null === e[i][a + 1] &&
                  ((c += b.move(s, r)),
                  (d = d + b.line(s - l, h) + b.move(s, r))),
                  null === e[i][a] &&
                    ((c += b.move(s, r)), (d += b.move(s, h))),
                  "stepline" === v
                    ? ((c = c + b.line(s, null, "H") + b.line(null, r, "V")),
                      (d = d + b.line(s, null, "H") + b.line(null, r, "V")))
                    : "straight" === v &&
                      ((c += b.line(s, r)), (d += b.line(s, r))),
                  a === e[i].length - 2 &&
                    ((d = d + b.line(s, h) + b.move(s, r) + "z"),
                    g.push(c),
                    u.push(d));
              return {
                linePaths: g,
            ...
            value: function (t) {
              ...
              if (0 === n) {
                ...
                c.globals.isXNumeric &&
                  ...
                  d.push(f),
                  u.push(
                    g.isNumber(e[r][0]) ? o + c.config.markers.offsetY : null
                  ),
          ...
          },
          {
            ...
            value: function (t) {
              ...
              if (void 0 !== i[e][0])
                r =
                  (o = l.config.chart.stacked && e > 0 ? n[e - 1][0] : s) -
                  i[e][0] / a +
            ...
            value: function (t, e, i) {
              ...
              r.logarithmic && n <= 5 && (a.invalidLogScale = !0),
                r.logarithmic && n > 5
                  ...
                  : i !== -Number.MAX_VALUE && g.isNumber(i)
                  ? ((a.allSeriesCollapsed = !1),
    ...
    xt = (function () {
      function t(i) {
        e(this, t), (this.ctx = i), (this.w = i.w), (this.scales = new pt(i));
      }
      return (
        a(t, [
          {
            ...
            value: function () {
              ...
              if (e.isXNumeric)
                for (var s = 0; s < e.series.length; s++)
                  if (e.labels[s])
                    for (var r = 0; r < e.labels[s].length; r++)
                      null !== e.labels[s][r] &&
                        g.isNumber(e.labels[s][r]) &&
                        ((e.maxX = Math.max(e.maxX, e.labels[s][r])),
                        (e.initialmaxX = Math.max(e.maxX, e.labels[s][r])),
                        (e.minX = Math.min(e.minX, e.labels[s][r])),
                        (e.initialminX = Math.min(e.minX, e.labels[s][r])));
              if (
                (e.noLabelsProvided &&
            ...
            value: function (t, e) {
              ...
              return v.filter(function (t) {
                ...
                void 0 !== a.config.xaxis.tickAmount &&
                  ...
                  v.length > s && (e = Math.floor(v.length / s));
                var n = !1,
                  o = !1;
        ...
        a(t, [
              ...
              if (s.comboCharts) {
                if (
                  ...
                  if (i.config.chart.stacked) {
                    var v = new at(this.ctx, e);
                    b.push(v.draw(h.series, h.i));
                  } else {
                    var m = new it(this.ctx, e);
                ...
                switch (a.chart.type) {
                  ...
                  case "area":
                    ...
                    break;
                  case "bar":
                    if (a.chart.stacked) b = new at(this.ctx, e).draw(s.series);
                    else b = new it(this.ctx, e).draw(s.series);
                    break;
                  case "candlestick":
                    b = new st(this.ctx, e).draw(s.series);
                    break;
                  case "rangeBar":
                    b = p.draw(s.series);
                    break;
                  case "heatmap":
                    b = new nt(this.ctx, e).draw(s.series);
                    break;
                  case "pie":
                  case "donut":
                    b = u.draw(s.series);
          ...
          },
          {
            ...
            value: function () {
              ...
              ("top" !== t.config.legend.position &&
                "bottom" !== t.config.legend.position) ||
                (i = new ut(this.ctx).getLegendBBox().clwh + 10);
            ...
            value: function (t, e) {
              ...
              for (var o = 0; o < t[r].data.length; o++) {
                var l = "string" == typeof t[r].data[o].x,
                  h = !!s.isValidDate(t[r].data[o].x.toString());
                l || h
                  ? l
          ...
          },
          {
            ...
            value: function (t, e, i) {
              var a = [],
                ...
                o = new gt(this.ctx).getActiveConfigSeriesIndex();
              if ("array" === t) {
        ...
        a(t, [
          ...
          },
          {
            ...
            value: function () {
              ...
              e && (e.setAttribute("x1", -500), e.setAttribute("x2", -500)),
                    ...
                    if (
                      ...
                      if (o.globals.isBarHorizontal) {
                        var a = o.globals.yLabelFormatters[0],
                          s = new gt(e.ctx).getActiveSeriesIndex();
        ...
        a(t, [
          ...
          },
          {
            ...
            value: function () {
              ...
              n.appendChild(e.dom.elGridRectMask),
                n.appendChild(e.dom.elGridRectMarkerMask);
            },
          },
          {
            key: "_drawGridLines",
            value: function (t) {
              ...
              (0 === e && l.globals.skipFirstTimelinelabel) ||
                ...
                new T(this.ctx).drawXaxisTicks(i, this.elg));
            },
          },
          {
            key: "_drawGridLine",
              ...
              if (
                ...
                for (
                  ...
                  i.config.grid.xaxis.lines.show &&
                    ...
                    new T(this.ctx).drawXaxisTicks(s, this.elg),
                    ...
                    var t =
                      ...
                      n =
                        window.innerWidth > 0
                          ...
                          : screen.width;
                    if (n > a) {
                      var o = X.extendArrayProps(r, i.globals.initialConfig);
                      (t = g.extend(o, t)),
                      ...
                      for (var l = 0; l < s.length; l++)
                        n < s[l].breakpoint &&
                          ((t = X.extendArrayProps(r, s[l].options)),
                          (t = g.extend(i.config, t)),
                          e.overrideResponsiveOptions(t));
                  };
                if (t) {
                  var o = X.extendArrayProps(r, t);
        ...
        a(t, [
          {
            ...
            value: function (t) {
              ...
              for (
                var f, p = null, x = null, b = [], v = 0;
                v < n.globals.seriesXvalues.length;
                v++
              )
                b.push(
                  [n.globals.seriesXvalues[v][0] - 1e-6].concat(
                    n.globals.seriesXvalues[v]
                  )
                );
              return (
                (b = b.map(function (t) {
          ...
          },
          {
            ...
            value: function (t) {
              ...
              a.globals.isXNumeric && "datetime" === a.config.xaxis.type
                ? (r = new P(this.ctx).xLabelFormat(
                    a.globals.ttKeyFormatter,
                    c,
                    c
                  ))
                : a.globals.isBarHorizontal ||
                  (r = a.globals.xLabelFormatter(c, l));
              return (
                void 0 !== a.config.tooltip.x.formatter &&
                  (r = a.globals.ttKeyFormatter(c, l)),
                a.globals.seriesZ.length > 0 &&
                  a.globals.seriesZ[0].length > 0 &&
                  (n = h(a.globals.seriesZ[e][i], a)),
                {
                  val: o,
                  xVal: r,
                  xAxisTTVal:
        ...
        a(t, [
            ...
            value: function (t) {
              ...
              if (
                ...
                "barWidth" === a.config.xaxis.crosshairs.width
                  ? r + i.xcrosshairsWidth > a.globals.gridWidth &&
                    (r = a.globals.gridWidth - i.xcrosshairsWidth)
                  : null !== e && (r += a.globals.gridWidth / n / 2),
                r < 0 && (r = 0),
          ...
          },
          {
            ...
            value: function (t) {
              ...
              e = new gt(this.ctx).getActiveSeriesIndex();
    ...
    Et = (function () {
      function t(i) {
        ...
        (this.tConfig = a.config.tooltip),
          ...
          (this.tooltipLabels = new Ct(this)),
          (this.tooltipPosition = new Lt(this)),
          (this.marker = new Pt(this)),
          (this.intersect = new zt(this)),
          (this.axesTooltip = new Tt(this)),
            ...
            value: function (t) {
              ...
              !i.hasBars() || r.globals.comboCharts || i.isBarShared) ||
                (this.tConfig.onDatasetHover.highlightDataSeries &&
                  new gt(e).toggleSeriesOnHover(s, s.target.parentNode));
          ...
          },
          {
            ...
            value: function (t, e) {
              ...
              i.config.chart.zoom.autoScaleYaxis &&
                (n = new pt(this.ctx).autoScaleY(this.ctx, n, { xaxis: a }));
          ...
          },
          {
            ...
            value: function () {
              ...
              window.setTimeout(function () {
                t.elMenu.classList.contains("open")
                  ? t.elMenu.classList.remove("open")
                  : t.elMenu.classList.add("open");
              }, 0);
            },
          },
          {
            key: "downloadPNG",
            value: function () {
              new yt(this.ctx).exportToPng(this.ctx);
            },
          },
          {
            key: "downloadSVG",
            value: function () {
              new yt(this.ctx).exportToSVG();
            },
          },
          {
            key: "downloadCSV",
            value: function () {
              var t = this.w;
              new yt(this.ctx).exportToCSV({ series: t.config.series });
            },
          },
          {
            key: "handleZoomReset",
        ...
        a(i, [
            ...
            value: function (t) {
              ...
              if (void 0 !== a.globals.lastClientPosition.x) {
                ...
                Math.abs(r) > Math.abs(n) && r > 0
                  ...
                  ? (e = "up")
                  : Math.abs(n) > Math.abs(r) && n < 0 && (e = "down");
              }
          ...
          },
          {
            ...
            value: function (t, e, i) {
              var a = this.w,
                s = this.xyRatios,
                r = g.clone(a.globals.initialConfig.yaxis);
              "left" === t
              ...
              var n = { min: e, max: i };
              a.config.chart.zoom.autoScaleYaxis &&
                (r = new pt(this.ctx).autoScaleY(this.ctx, r, { xaxis: n }));
              var o = { xaxis: { min: e, max: i } };
              a.config.chart.group || (o.yaxis = r),
          ...
          },
          {
            ...
            value: function (t) {
              ...
              if (
                ...
                (a += i.offsetX),
                (s = s + parseInt(i.style.fontSize, 10) + 2),
                void 0 !== i.text)
              ) {
  ...
  (D = "undefined" != typeof window ? window : void 0),
    (F = function (e, i) {
          ...
          clone: function () {
            ...
            return (
              (t.value = (function t(e) {
                for (var i = e.slice(0), a = i.length; a--; )
        ...
        (a.Matrix = a.invent({
          create: function (e) {
            ...
            for (
              ...
              this[m[i]] = null != e[m[i]] ? e[m[i]] : s[m[i]];
          },
          extend: {
            extract: function () {
              var t = f(this, 0, 1),
        ...
        (a.Transformation = a.invent({
          ...
          extend: {
            ...
            at: function (t) {
              ...
              var r = this._undo || new a.Matrix();
              return (
                (r = new a.Matrix()
                  .morph(a.Matrix.prototype[this.method].apply(r, e))
                  .at(t)),
            ...
            if (e instanceof a.Element) {
              for (
                l = e,
                  ...
                  e.bbox,
                  r = new a.Number(e.width()),
                  n = new a.Number(e.height());
                "%" == r.unit;
      ...
      var m = "abcdef".split("");
      return (a.CustomEvent = e.CustomEvent), a;
    }),
    "function" == typeof define && define.amd
      ? define(function () {
          return F(D, D.document);
        })
      : "object" ===
      ...
      ? (module.exports = D.document
          ? F(D, D.document)
          : function (t) {
              return F(t, t.document);
            })
      : (D.SVG = F(D, D.document)),
          ...
          case "A":
            t = (e = (function (t, e) {
              var i,
                ...
                D = new SVG.Point(X, Y),
                F = [];
              if (0 === z || 0 === T || (R.x === D.x && R.y === D.y))
                return [["C", R.x, R.y, D.x, D.y, D.x, D.y]];
              (i = new SVG.Point((R.x - D.x) / 2, (R.y - D.y) / 2).transform(
        ...
        a(
          ...
          [
            ...
            },
            {
              ...
              value: function () {
                (this.animations = new f(this)),
                  (this.axes = new I(this)),
                  (this.core = new vt(this.el, this)),
                  (this.data = new mt(this)),
                  (this.grid = new wt(this)),
                  (this.coreUtils = new X(this)),
                  (this.config = new U({})),
                  (this.crosshairs = new rt(this)),
                  (this.options = new j()),
                  (this.responsive = new kt(this)),
                  (this.series = new gt(this)),
                  (this.theme = new At(this)),
                  (this.formatters = new P(this)),
                  (this.titleSubtitle = new Xt(this)),
                  (this.legend = new ut(this)),
                  (this.toolbar = new It(this)),
                  (this.dimensions = new dt(this)),
                  (this.zoomPanSelection = new Mt(this)),
                  (this.w.globals.tooltip = new Et(this));
              },
            },
            {
            ...
            },
            {
              ...
              value: function (t, e) {
                ...
                (a.comboCharts = s.comboCharts),
                  ...
                  this.theme.init(),
                  new J(this).setGlobalMarkerSize(),
                ...
                return new Promise(function (s, r) {
                  ...
                  if (
                    ...
                    if (
                      ...
                      a.globals.axisCharts && a.globals.isXNumeric)
                    )
              ...
              value: function (e) {
                var i =
                  ...
                  r =
                    ...
                    arguments[4],
                  n = [this];
                s && (n = this.getSyncedCharts()),
                  this.w.globals.isExecCalled &&
                    ((n = [this]), (this.w.globals.isExecCalled = !1)),
                  n.forEach(function (s) {
                    ...
                    return (
                      ...
                      e &&
                        "object" === t(e) &&
                        ((s.config = new U(e)),
                        (e = X.extendArrayProps(s.config, e)),
            ...
            },
            {
              key: "dataURI",
              value: function () {
                return new yt(this.ctx).dataURI();
              },
            },
            {
              key: "paper",
