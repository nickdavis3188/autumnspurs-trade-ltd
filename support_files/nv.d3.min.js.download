...
!(function () {
  ...
  (a.dev = !1),
    ...
    a.dev &&
      (a.dispatch.on("render_start", function (b) {
    ...
    (a.interactiveGuideline = function () {
        ...
        l.each(function (l) {
          function m() {
            var a = d3.event.clientX - this.getBoundingClientRect().left,
              d = d3.event.clientY - this.getBoundingClientRect().top,
              e = !0,
              h = !1;
            if (
              (k &&
                ((a = d3.event.offsetX),
                (d = d3.event.offsetY),
                "svg" !== d3.event.target.tagName && (e = !1),
                d3.event.target.className.baseVal.match("nv-legend") &&
                  (h = !0)),
              e && ((a -= c.left), (d -= c.top)),
              "mouseout" === d3.event.type ||
                0 > a ||
                0 > d ||
                a > o ||
                d > p ||
              ...
              if (
                ...
                return;
              return (
                g.elementMouseout({ mouseX: a, mouseY: d }),
                b.renderGuideLine(null),
                void j.hidden(!0)
              );
            }
            j.hidden(!1);
            var i = "function" == typeof f.rangeBands,
              l = void 0;
            if (i) {
              var m = d3.bisect(f.range(), a) - 1;
              if (!(f.range()[m] + f.rangeBand() >= a))
                return (
                  g.elementMouseout({ mouseX: a, mouseY: d }),
                  b.renderGuideLine(null),
                  void j.hidden(!0)
            ...
            g.elementMousemove({ mouseX: a, mouseY: d, pointXValue: l }),
              "dblclick" === d3.event.type &&
                g.elementDblclick({ mouseX: a, mouseY: d, pointXValue: l }),
              "click" === d3.event.type &&
                g.elementClick({ mouseX: a, mouseY: d, pointXValue: l }),
              "mousedown" === d3.event.type &&
                g.elementMouseDown({ mouseX: a, mouseY: d, pointXValue: l }),
              "mouseup" === d3.event.type &&
                g.elementMouseUp({ mouseX: a, mouseY: d, pointXValue: l });
          }
      ...
      return (
        j.duration(0).hideDelay(0).hidden(!1),
        (b.dispatch = g),
        (b.tooltip = j),
        (b.margin = function (a) {
    ...
    (a.models.tooltip = function () {
      ...
      var d = "nvtooltip-" + Math.floor(1e5 * Math.random()),
        ...
        u = function (a, b) {
          ...
          var e = c.selectAll("tbody").data([a]).enter().append("tbody"),
            f = e
              .selectAll("tr")
              .data(function (a) {
                return a.series;
          ...
          return (
            void 0 !== a.footer &&
              (g += "<div class='footer'>" + a.footer + "</div>"),
            g
          );
        },
        v = function () {
          ...
          a.dom.read(function () {
            ...
            if (j)
              ...
              var e = "translate(" + m.left + "px, " + m.top + "px)",
                f =
                  "translate(" + Math.round(c) + "px, " + Math.round(d) + "px)",
                g = d3.interpolateString(e, f),
                h = l.style("opacity") < 0.1;
              l.interrupt()
                .transition()
                .duration(h ? 0 : o)
                .styleTween(
    ...
    (a.utils.calcApproxTextWidth = function (b) {
      if (a.utils.isFunction(b.style) && a.utils.isFunction(b.text)) {
        var c = parseInt(b.style("font-size").replace("px", ""), 10),
          d = b.text().length;
        return a.utils.NaNtoZero(d * c * 0.5);
      }
      return 0;
    }),
    (a.utils.NaNtoZero = function (b) {
      return !a.utils.isNumber(b) ||
        isNaN(b) ||
        null === b ||
        b === 1 / 0 ||
        b === -(1 / 0)
    ...
    (a.utils.inheritOptionsD3 = function (a, b, c) {
      (a._d3options = c.concat(a._d3options || [])),
        (a._d3options = (a._d3options || []).filter(function (a, b, c) {
        ...
        return (
          ...
          h.each(function (b) {
            ...
            var r = h.selectAll("g.nv-wrap.nv-axis").data([b]),
              s = r.enter().append("g").attr("class", "nvd3 nv-wrap nv-axis"),
              v = (s.append("g"), r.select("g"));
            null !== o
              ? d.ticks(o)
              : ("top" == d.orient() || "bottom" == d.orient()) &&
                d.ticks(Math.abs(e.range()[1] - e.range()[0]) / 100),
              v.watchTransition(u, "axis").call(d),
              (t = t || d.scale());
            var w = d.tickFormat();
            ...
            x.exit().remove(),
              void 0 !== q &&
                v.selectAll("g").select("text").style("font-size", q);
            var y, z, A;
            switch (d.orient()) {
              case "top":
                x.enter().append("text").attr("class", "nv-axislabel"),
                  (A = 0),
                  1 === e.range().length
                    ? (A = n ? 2 * e.range()[0] + e.rangeBand() : 0)
                    : 2 === e.range().length
                    ? (A = n
                        ? e.range()[0] + e.range()[1] + e.rangeBand()
                        : e.range()[1])
                    : e.range().length > 2 &&
                      (A =
                  ...
                  x
                    ...
                    .attr("x", A / 2),
                  j &&
                    ((z = r.selectAll("g.nv-axisMaxMin").data(e.domain())),
                    z
                      .enter()
                      .append("g")
                    ...
                    z
                      .watchTransition(u, "min-max top")
                      .attr("transform", function (b, c) {
                        return (
                          "translate(" + a.utils.NaNtoZero(e.range()[c]) + ",0)"
                        );
                      }));
                break;
              case "bottom":
                ...
                if (k % 360) {
                  D.attr("transform", ""),
                    ...
                    (E =
                      "rotate(" + k + " 0," + (C / 2 + d.tickPadding()) + ")");
                  var F = Math.abs(Math.sin((k * Math.PI) / 180));
                  (y = (F ? F * B : B) + 30),
                    D.attr("transform", E).style(
                      "text-anchor",
                      k % 360 > 0 ? "start" : "end"
                    );
                } else
                  m
                    ? D.attr("transform", function (a, b) {
                ...
                x.enter().append("text").attr("class", "nv-axislabel"),
                  ...
                  j &&
                    ...
                    z
                      .watchTransition(u, "min-max bottom")
                      .attr("transform", function (b, c) {
                        return (
                          "translate(" +
                          a.utils.NaNtoZero(
              ...
              case "right":
                x.enter().append("text").attr("class", "nv-axislabel"),
                  x
                    .style("text-anchor", l ? "middle" : "begin")
                    .attr("transform", l ? "rotate(90)" : "")
                    .attr("y", l ? -Math.max(f.right, g) + 12 - (p || 0) : -10)
                    .attr("x", l ? d3.max(e.range()) / 2 : d.tickPadding()),
                  j &&
                    ((z = r.selectAll("g.nv-axisMaxMin").data(e.domain())),
                    z
                      .enter()
                    ...
                    z
                      .watchTransition(u, "min-max right")
                      .attr("transform", function (b, c) {
                        return (
                          "translate(0," + a.utils.NaNtoZero(e.range()[c]) + ")"
                        );
                      })
                      .select("text")
                      .style("opacity", 1));
              ...
              case "left":
                x.enter().append("text").attr("class", "nv-axislabel"),
                  x
                    .style("text-anchor", l ? "middle" : "end")
                    .attr("transform", l ? "rotate(-90)" : "")
                    .attr("y", l ? -Math.max(f.left, g) + 25 - (p || 0) : -10)
                    .attr("x", l ? -d3.max(e.range()) / 2 : -d.tickPadding()),
                  j &&
                    ((z = r.selectAll("g.nv-axisMaxMin").data(e.domain())),
                    z
            ...
            if (
              ...
              !j ||
                ("left" !== d.orient() && "right" !== d.orient()) ||
                (v.selectAll("g").each(function (a, b) {
                  d3.select(this).select("text").attr("opacity", 1),
                    (e(a) < e.range()[1] + 10 || e(a) > e.range()[0] - 10) &&
                      ((a > 1e-10 || -1e-10 > a) &&
                        d3.select(this).attr("opacity", 0),
                      d3.select(this).select("text").attr("opacity", 0));
                }),
                e.domain()[0] == e.domain()[1] &&
                  0 == e.domain()[0] &&
                  r
                    .selectAll("g.nv-axisMaxMin")
              ...
              r.selectAll("g.nv-axisMaxMin").each(function (a, b) {
                try {
                  b
                    ? G.push(e(a) - this.getBoundingClientRect().width - 4)
                    : G.push(e(a) + this.getBoundingClientRect().width + 4);
                } catch (c) {
          ...
          {},
          {
            ...
            scale: {
              ...
              set: function (c) {
                (e = c),
                  d.scale(e),
                  (n = "function" == typeof e.rangeBands),
                  a.utils.inheritOptionsD3(b, e, [
                    "domain",
                    "range",
                    "rangeBand",
                    "rangeBands",
    ...
    (a.models.boxPlot = function () {
      ...
      function b(l) {
        return (
          ...
          E.renderEnd("nv-boxplot immediate"),
          b
        );
      }
      var c,
        ...
        return (
          e.each(function (c, e) {
            ...
            b(D, z),
              ...
              b(F, B),
              b(G, C),
              z.sort(d3.descending),
              A.sort(d3.descending),
              B.sort(d3.descending),
              C.sort(d3.descending);
            var H = d3.scale
              .linear()
              .domain(d3.extent(d3.merge([o, z])))
              .range(f ? [s, 0] : [0, s]);
            this.__chart__ ||
              d3.scale
                .linear()
            ...
            for (
              ...
              2 >= e && (N = N + " nv-range" + w[e]),
                K.append("rect").attr("class", N);
            }
            K.append("rect").attr("class", "nv-measure"),
              I.attr("transform", "translate(" + d.left + "," + d.top + ")");
            for (
              var O = function (a) {
            ...
            L.select("rect.nv-measure")
              ...
              .transition()
              .duration(x)
              .attr("width", 0 > C ? H(0) - H(C[0]) : H(C[0]) - H(0))
              .attr("x", P(C));
            var R = y / 6,
            ...
            K.selectAll("path.nv-markerTriangle")
              ...
              L.selectAll("path.nv-markerTriangle")
                .data(S)
                .transition()
                .duration(x)
            ...
            K.selectAll("line.nv-markerLine")
              .data(T)
              .enter()
              .append("line")
              .attr("cursor", "")
              ...
              L.selectAll("line.nv-markerLine")
                .data(T)
                .transition()
                .duration(x)
                .attr("x1", function (a) {
    ...
    (a.models.cumulativeLineChart = function () {
      ...
      function b(m) {
        return (
          ...
          m.each(function (m) {
            ...
            var P = a.utils.availableWidth(q, O, n),
              Q = a.utils.availableHeight(r, O, n);
            if (
              ((b.update = function () {
                0 === F ? O.call(b) : O.transition().duration(F).call(b);
              }),
              (b.container = this),
              A.setter(M(m), b.update).getter(L(m)).update(),
              (A.disabled = m.map(function (a) {
                return !!a.disabled;
              })),
              !B)
            ) {
              ...
              B = {};
              for (R in A)
                A[R] instanceof Array ? (B[R] = A[R].slice(0)) : (B[R] = A[R]);
            }
            var S = d3.behavior
              .drag()
              .on("dragstart", C)
            ...
            if (
              ...
              return a.utils.noData(b, O), b;
            O.selectAll(".nv-noData").remove(),
              (e = g.xScale()),
              (f = g.yScale()),
              I.domain([0, m[0].values.length - 1])
                .range([0, P])
                .clamp(!0);
            var m = c(J.i, m);
            "undefined" == typeof H && (H = d(m)),
              y ? g.yDomain(null) : (g.yDomain(H), g.clipEdge(!0));
            var T = x ? "none" : "all",
              U = O.selectAll("g.nv-wrap.nv-cumulativeLine").data([m]),
              V = U.enter()
                .append("g")
            ...
            if (
              ...
              s
                ? (j.width(P),
                  W.select(".nv-legendWrap").datum(m).call(j),
                  o ||
                    j.height() === n.top ||
                    ((n.top = j.height()),
                    (Q = a.utils.availableHeight(r, O, n))),
              ...
              k
                ...
                W.select(".nv-controlsWrap")
                  .datum(X)
                  .attr("transform", "translate(0," + -n.top + ")")
                  .call(k);
            ...
            U.select(".tempDisabled").remove(),
              ...
              x &&
                (l
                  .width(P)
                  .height(Q)
                  .margin({ left: n.left, top: n.top })
                  .svgContainer(O)
                  .xScale(e),
                U.select(".nv-interactive").call(l)),
            ...
            ba
              ...
              t &&
                (h
                  .scale(e)
                  ._ticks(a.utils.calcTicksX(P / 70, m))
                  .tickSize(-Q, 0),
                W.select(".nv-x.nv-axis").attr(
                  "transform",
                  "translate(0," + f.range()[0] + ")"
                ),
                W.select(".nv-x.nv-axis").call(h)),
              u &&
                (i
                  .scale(f)
                  ._ticks(a.utils.calcTicksY(Q / 36, m))
                  .tickSize(-P, 0),
                W.select(".nv-y.nv-axis").call(i)),
              W.select(".nv-background rect").on("click", function () {
                (J.x = d3.mouse(this)[0]),
                  (J.i = Math.round(I.invert(J.x))),
                  (A.index = J.i),
                  E.stateChange(A),
                  N();
              }),
              ...
              l.dispatch.on("elementMousemove", function (c) {
                ...
                if (
                  (m
                    .filter(function (a, b) {
                      return (
                        (a.seriesIndex = b), !(a.disabled || a.tempDisabled)
                      );
                    })
                    .forEach(function (h, i) {
                      (e = a.interactiveBisect(h.values, c.pointXValue, b.x())),
                        g.highlightPoint(i, e, !0);
                      var k = h.values[e];
                      "undefined" != typeof k &&
              ...
              E.on("changeState", function (a) {
                "undefined" != typeof a.disabled &&
                  ...
                  "undefined" != typeof a.index &&
                    ...
                    (A.index = a.index),
                    ba.data([J])),
                  "undefined" != typeof a.rescaleY && (y = a.rescaleY),
                  b.update();
              });
          }),
          K.renderEnd("cumulativeLineChart immediate"),
          b
        );
      }
      function c(a, b) {
      ...
      var e,
        ...
        j = a.models.legend(),
        k = a.models.legend(),
        l = a.interactiveGuideline(),
        m = a.models.tooltip(),
        n = { top: 30, right: 30, bottom: 50, left: 60 },
        o = null,
      ...
      (A.index = 0),
        (A.rescaleY = y),
        h.orient("bottom").tickPadding(7),
        i.orient(v ? "right" : "left"),
        m
          .valueFormatter(function (a, b) {
      ...
      var H,
        ...
        M = function (a) {
          return function (b) {
            void 0 !== b.index && (J.i = b.index),
              void 0 !== b.rescaleY && (y = b.rescaleY),
              void 0 !== b.active &&
        ...
        (b._options = Object.create(
          {},
          {
            ...
            margin: {
              ...
              set: function (a) {
                void 0 !== a.top && ((n.top = a.top), (o = a.top)),
                  (n.right = void 0 !== a.right ? a.right : n.right),
                  (n.bottom = void 0 !== a.bottom ? a.bottom : n.bottom),
                  (n.left = void 0 !== a.left ? a.left : n.left);
              },
            },
            color: {
              get: function () {
    ...
    (a.models.discreteBarChart = function () {
        ...
        return (
          ...
          i.each(function (i) {
            ...
            A.append("g").attr("class", "nv-x nv-axis"),
              ...
              C.attr("transform", "translate(" + j.left + "," + j.top + ")"),
              o
                ? (h.width(v),
                  C.select(".nv-legendWrap").datum(i).call(h),
                  k ||
                    h.height() === j.top ||
                    ((j.top = h.height()),
                    (y = a.utils.availableHeight(m, n, j))),
                ...
                : C.select(".nv-legendWrap").selectAll("*").remove(),
              r &&
                C.select(".nv-y.nv-axis").attr(
                  "transform",
                  "translate(" + v + ",0)"
                ),
              e.width(v).height(y);
            var D = C.select(".nv-barsWrap").datum(
              i.filter(function (a) {
                return !a.disabled;
              })
            );
            if (
              ...
              B.append("clipPath")
                .attr("id", "nv-x-label-clip-" + e.id())
                .append("rect"),
              C.select("#nv-x-label-clip-" + e.id() + " rect")
                .attr("width", c.rangeBand() * (s ? 2 : 1))
                .attr("height", 16)
                .attr("x", -c.rangeBand() / (s ? 1 : 2)),
              p)
            ) {
              f
                .scale(c)
                ._ticks(a.utils.calcTicksX(v / 100, i))
                .tickSize(-y, 0),
                C.select(".nv-x.nv-axis").attr(
                  "transform",
                  "translate(0," +
                    (d.range()[0] +
              ...
              s &&
                E.selectAll("text").attr("transform", function (a, b, c) {
                  return "translate(0," + (c % 2 == 0 ? "5" : "17") + ")";
                }),
                u &&
                  E.selectAll(".tick text")
                    .attr("transform", "rotate(" + u + " 0,0)")
                    .style("text-anchor", u > 0 ? "start" : "end"),
                t &&
                  C.selectAll(".tick text").call(
                    a.utils.wrapTicks,
                    b.xAxis.rangeBand()
                  );
            }
            q &&
              (g
                .scale(d)
                ._ticks(a.utils.calcTicksY(y / 36, i))
                .tickSize(-v, 0),
              C.select(".nv-y.nv-axis").call(g)),
              C.select(".nv-zeroLine line")
                .attr("x1", 0)
                .attr("x2", r ? -v : v)
                .attr("y1", d(0))
                .attr("y2", d(0));
          }),
          y.renderEnd("discreteBar chart immediate"),
          b
        );
      }
      var c,
      ...
      f
        ...
        g.orient(r ? "right" : "left").tickFormat(d3.format(",.1f")),
        i
          .duration(0)
          .headerEnabled(!1)
          .valueFormatter(function (a, b) {
        ...
        (b._options = Object.create(
          {},
          {
            ...
            margin: {
              ...
              set: function (a) {
                void 0 !== a.top && ((j.top = a.top), (k = a.top)),
                  (j.right = void 0 !== a.right ? a.right : j.right),
                  (j.bottom = void 0 !== a.bottom ? a.bottom : j.bottom),
                  (j.left = void 0 !== a.left ? a.left : j.left);
              },
      ...
      function c(u) {
        return (
          ...
          u.each(function (t) {
            ...
            function v() {
              h.empty() || h.extent(p),
                E.data([h.empty() ? d.domain() : p]).each(function (a, b) {
            ...
            A.attr("transform", "translate(" + i.left + "," + i.top + ")"),
              B.append("g").attr("class", "nv-background").append("rect"),
              B.append("g").attr("class", "nv-x nv-axis"),
              B.append("g").attr("class", "nv-y nv-axis"),
              B.append("g").attr("class", "nv-contentWrap"),
              B.append("g").attr("class", "nv-brushBackground"),
              B.append("g").attr("class", "nv-x nv-brush"),
              o &&
                C.select(".nv-y.nv-axis").attr(
                  "transform",
                  "translate(" + y + ",0)"
                ),
              C.select(".nv-background rect")
                .attr("width", y)
                .attr("height", z),
              b
                .width(y)
            ...
            var D = C.select(".nv-contentWrap").datum(
              t.filter(function (a) {
                return !a.disabled;
              })
            );
            d3.transition(D).call(b),
              h.x(d).on("brush", function () {
                w(s);
              }),
              ...
              p && h.extent(p);
            var E = C.select(".nv-brushBackground")
                .selectAll("g")
                .data([p || h.extent()]),
              F = E.enter().append("g");
            F.append("rect")
            ...
            G.selectAll("rect").attr("height", z),
              G.selectAll(".resize").append("path").attr("d", u),
              w(!0),
              C.select(".nv-background rect")
                .attr("width", y)
                .attr("height", z),
              m &&
                (f
                  .scale(d)
                  ._ticks(a.utils.calcTicksX(y / 100, t))
                  .tickSize(-z, 0),
                C.select(".nv-x.nv-axis").attr(
                  "transform",
                  "translate(0," + e.range()[0] + ")"
                ),
                d3.transition(C.select(".nv-x.nv-axis")).call(f)),
              n &&
                (g
                  .scale(e)
                  ._ticks(a.utils.calcTicksY(z / 36, t))
                  .tickSize(-y, 0),
                d3.transition(C.select(".nv-y.nv-axis")).call(g)),
              C.select(".nv-x.nv-axis").attr(
                "transform",
                "translate(0," + e.range()[0] + ")"
              );
          }),
          t.renderEnd("focus immediate"),
          c
        );
      }
      var d,
      ...
      function b(g) {
        return (
          ...
          g.each(function (g) {
            ...
            if (
              (f.attr("width", j).attr("height", u), !(g && g.links && g.nodes))
            )
          ...
          r.each(function (b) {
            ...
            "furious" == q &&
              x
                ...
                .attr("y", -9)
                .attr("x", -15),
              x.style("fill", t).style("stroke", function (a, b) {
    ...
    (a.models.historicalBarChart = function (b) {
      ...
      function c(b) {
        return (
          ...
          A.renderEnd("historicalBarChart immediate"),
          c
        );
      }
      var d,
        ...
        (c._options = Object.create(
          {},
          {
            ...
            margin: {
              ...
              set: function (a) {
                void 0 !== a.top && ((l.top = a.top), (m = a.top)),
      ...
      function b(s) {
        function t(a, b) {
          return "furious" != r
            ...
            : p
            ? void 0
            : (a.color || (a.color = h(a, b)), a.disabled ? a.color : "#fff");
        }
        function u(a, b) {
          return p && "furious" == r && a.disengaged
            ? "#eee"
            : a.color || h(a, b);
        }
        function v(a, b) {
        ...
        return (
          s.each(function (b) {
            ...
            var w = s.selectAll("g.nv-legend").data([b]),
              ...
              y = w.select("g");
            l
              ? w.attr("transform", "translate(" + -c.right + "," + c.top + ")")
              : w.attr("transform", "translate(" + c.left + "," + c.top + ")");
            var z,
              A,
              B = y.selectAll(".nv-series").data(function (a) {
                return "furious" != r
                  ? a
                  : a.filter(function (a) {
              ...
              .on("dblclick", function (a, b) {
                if (n) {
                  ...
                  if ((q.legendDblclick(a, b), m)) {
                    ...
                    c.forEach(function (a) {
                      (a.disabled = !0),
                        "furious" == r && (a.userDisabled = a.disabled);
                    }),
                      (a.disabled = !1),
                      "furious" == r && (a.userDisabled = a.disabled),
                      q.stateChange({
            ...
            if (j) {
              ...
              for (0 === H && (H = 1); F > h && H > 1; ) {
                ...
                for (var J = 0; J < G.length; J++)
                  G[J] > (I[J % H] || 0) && (I[J % H] = G[J]);
                F = I.reduce(function (a, b, c, d) {
                  return a + b;
                });
              }
              for (var K = [], L = 0, M = 0; H > L; L++)
                (K[L] = M), (M += I[L]);
              B.attr("transform", function (a, b) {
                ...
                l
                  ...
                  : y.attr("transform", "translate(0," + c.top + ")"),
                (e = c.top + c.bottom + Math.ceil(G.length / H) * A);
            } else {
              var N,
                O = 5,
                P = 5,
              ...
              B.attr("transform", function (a, b) {
                ...
                return (
                  (N = P),
                  d < c.left + c.right + N + e && ((P = N = 5), (O += A)),
                  (P += e),
                  P > Q && (Q = P),
                  N + Q > F && (F = N + Q),
                  "translate(" + N + "," + O + ")"
                ...
                y.attr(
                  "transform",
                  "translate(" + (d - c.right - Q) + "," + c.top + ")"
                ),
                (e = c.top + c.bottom + O + 15);
            }
            if ("furious" == r) {
              z
                .attr("width", function (a, b) {
      ...
      function b(j) {
        return (
          ...
          j.each(function (j) {
            function z() {
              s &&
                M.select(".nv-focus .nv-x.nv-axis")
                  .transition()
                  .duration(B)
                  .call(f);
            }
            function C() {
              t &&
                M.select(".nv-focus .nv-y.nv-axis")
                  .transition()
                  .duration(B)
                  .call(g);
            }
            function F(a) {
              var b = M.select(".nv-focus .nv-linesWrap").datum(
                j
                  .filter(function (a) {
                    return !a.disabled;
                  })
            ...
            if (
              ...
              (b.container = this),
              x.setter(E(j), b.update).getter(D(j)).update(),
            ...
            G.selectAll(".nv-noData").remove(),
              k.dispatch.on("onBrush", function (a) {
                F(a);
              }),
              (c = e.xScale()),
              (d = e.yScale());
            ...
            N.append("g").attr("class", "nv-background").append("rect"),
              N.append("g").attr("class", "nv-x nv-axis"),
              N.append("g").attr("class", "nv-y nv-axis"),
              N.append("g").attr("class", "nv-linesWrap"),
              N.append("g").attr("class", "nv-interactive");
            L.append("g").attr("class", "nv-focusWrap");
            q
              ? (h.width(H),
                M.select(".nv-legendWrap").datum(j).call(h),
                "bottom" === r
                  ? ((l.bottom = f.height() + h.height()),
                    (I = a.utils.availableHeight(p, G, l)),
                    M.select(".nv-legendWrap").attr(
                      "transform",
                      "translate(0," + (I + f.height()) + ")"
                    ))
                  : "top" === r &&
                    (m ||
                      h.height() === l.top ||
                      ((l.top = h.height()),
                      (I =
                        a.utils.availableHeight(p, G, l) -
                        (w ? k.height() : 0))),
                    K.select(".nv-legendWrap").attr(
                      "transform",
                      "translate(0," + -l.top + ")"
                    )))
              : M.select(".nv-legendWrap").selectAll("*").remove(),
              K.attr("transform", "translate(" + l.left + "," + l.top + ")"),
              u &&
              ...
              v &&
                (i
                  ...
                  .svgContainer(G)
                  .xScale(c),
                K.select(".nv-interactive").call(i)),
              M.select(".nv-focus .nv-background rect")
                .attr("width", H)
                .attr("height", I),
              e
                .width(H)
            ...
            var O = M.select(".nv-linesWrap").datum(
              j.filter(function (a) {
                return !a.disabled;
              })
            );
            if (
              (s &&
                f
                  .scale(c)
                  ._ticks(a.utils.calcTicksX(H / 100, j))
                  .tickSize(-I, 0),
              t &&
                g
                  .scale(d)
                  ._ticks(a.utils.calcTicksY(I / 36, j))
                  .tickSize(-H, 0),
              M.select(".nv-focus .nv-x.nv-axis").attr(
                "transform",
                "translate(0," + I + ")"
              ),
              w || null !== k.brush.extent())
            ) {
              k.width(H),
                M.select(".nv-focusWrap")
                  .style("display", w ? "initial" : "none")
                  .attr(
                    "transform",
                    "translate(0," + (I + l.bottom + k.margin().top) + ")"
                  )
                  .call(k);
              ...
              i.dispatch.on("elementMousemove", function (d) {
                ...
                if (
                  (j
                    .filter(function (a, b) {
                      return (
                        (a.seriesIndex = b), !a.disabled && !a.disableTooltip
                      );
                    })
                    .forEach(function (g, i) {
                      var j =
                        ...
                        o = g.values.filter(function (a, b) {
                          return j[0] <= j[1]
                            ? e.x()(a, b) >= j[0] && e.x()(a, b) <= j[1]
                            : e.x()(a, b) >= j[1] && e.x()(a, b) <= j[0];
                        });
                      h = a.interactiveBisect(o, d.pointXValue, e.x());
                      var p = o[h],
                        q = b.y()(p, h);
                      null !== q && e.highlightPoint(i, h, !0),
                        void 0 !== p &&
                          (void 0 === f && (f = p),
                ...
                i.tooltip
                  .valueFormatter(i.tooltip.valueFormatter() || s)
                  .data({ value: b.x()(f, h), index: h, series: m })(),
                  i.renderGuideLine(l);
              }),
          ...
          C.renderEnd("lineChart immediate"),
          b
        );
      }
      var c,
          ...
          {},
          {
            ...
            focusMargin: {
              ...
              set: function (a) {
                void 0 !== a.top && ((l.top = a.top), (m = a.top)),
                  (k.margin.right =
                    void 0 !== a.right ? a.right : k.margin.right),
                  (k.margin.bottom =
      ...
      function b(v) {
        return (
          v.each(function (v) {
            ...
            function S() {
              u.empty() || u.extent(J),
                na.data([u.empty() ? e.domain() : J]).each(function (a, b) {
            ...
            function T() {
              (J = u.empty() ? null : u.extent()),
                (c = u.empty() ? e.domain() : u.extent()),
                L.brush({ extent: c, brush: u }),
                S(),
                l
                  .width(Y)
                  .height(Z)
              ...
              var b = ga.select(".nv-focus .nv-barsWrap").datum(
                  aa.length
                    ? aa.map(function (a, b) {
                        return {
                          key: a.key,
                ...
                h = ga.select(".nv-focus .nv-linesWrap").datum(
                  W(ba)
                    ? [{ values: [] }]
                    : ba
                        .filter(function (a) {
              ...
              (d = aa.length && !R ? l.xScale() : j.xScale()),
                n
                  .scale(d)
                  ._ticks(a.utils.calcTicksX(Y / 100, v))
                  .tickSize(-Z, 0),
                n.domain([Math.ceil(c[0]), Math.floor(c[1])]),
                ga.select(".nv-x.nv-axis").transition().duration(M).call(n),
                b.transition().duration(M).call(l),
                h.transition().duration(M).call(j),
                ga
                  .select(".nv-focus .nv-x.nv-axis")
                  .attr("transform", "translate(0," + f.range()[0] + ")"),
                p
                  .scale(f)
                  ._ticks(a.utils.calcTicksY(Z / 36, v))
                  .tickSize(-Y, 0),
                q.scale(g)._ticks(a.utils.calcTicksY(Z / 36, v)),
                R
                  ? q.tickSize(ba.length ? 0 : -Y, 0)
                  : q.tickSize(aa.length ? 0 : -Y, 0);
              var i = aa.length ? 1 : 0,
                k = ba.length && !W(ba) ? 1 : 0,
                m = R ? k : i,
                o = R ? i : k;
              ga.select(".nv-focus .nv-y1.nv-axis").style("opacity", m),
                ga
            ...
            if (
              ...
              (b.container = this),
              N.setter(V(v), b.update).getter(U(v)).update(),
              (N.disabled = v.map(function (a) {
                return !!a.disabled;
              })),
              !O)
            ) {
            ...
            (d = aa.length && !R ? l.xScale() : j.xScale()),
              (e = o.scale()),
              (f = R ? j.yScale() : l.yScale()),
              (g = R ? l.yScale() : j.yScale()),
              (h = R ? k.yScale() : m.yScale()),
              (i = R ? m.yScale() : k.yScale());
            var ca = v
                .filter(function (a) {
            ...
            d.range([0, Y]),
              e
                .domain(
                  d3.extent(d3.merge(ca.concat(da)), function (a) {
                    return a.x;
                  })
                )
                .range([0, Y]);
            ...
            ha.append("g").attr("class", "nv-x nv-axis"),
            ...
            if (
              (ia.append("g").attr("class", "nv-x nv-axis"),
              ia.append("g").attr("class", "nv-y1 nv-axis"),
              ia.append("g").attr("class", "nv-y2 nv-axis"),
              ia.append("g").attr("class", "nv-barsWrap"),
              ia.append("g").attr("class", "nv-linesWrap"),
              ia.append("g").attr("class", "nv-brushBackground"),
              ia.append("g").attr("class", "nv-x nv-brush"),
              E)
            ) {
              ...
              t.width(ja),
                  ...
                  .datum(
                    v.map(function (a) {
                      return (
                        ...
                        R
                          ? (a.key = a.originalKey + (a.bar ? Q : P))
                          : (a.key = a.originalKey + (a.bar ? P : Q)),
                        a
                      );
                    })
                  )
                ...
                x ||
                  t.height() === w.top ||
                  ((w.top = t.height()),
                  (Z = a.utils.availableHeight(A, X, w) - I)),
                ga
                  .select(".nv-legendWrap")
                  .attr("transform", "translate(" + ka + "," + -w.top + ")");
            } else ga.select(".nv-legendWrap").selectAll("*").remove();
            ea.attr("transform", "translate(" + w.left + "," + w.top + ")"),
              ga.select(".nv-context").style("display", F ? "initial" : "none"),
              m
                .width(Y)
                .height($)
                .color(
            ...
            var la = ga
                ...
                .datum(aa.length ? aa : [{ values: [] }]),
              ma = ga.select(".nv-context .nv-linesWrap").datum(
                W(ba)
                  ? [{ values: [] }]
            ...
            ga
              .select(".nv-context")
              .attr("transform", "translate(0," + (Z + w.bottom + y.top) + ")"),
              la.transition().call(m),
              ma.transition().call(k),
              H &&
                (o._ticks(a.utils.calcTicksX(Y / 100, v)).tickSize(-$, 0),
                ga
                  .select(".nv-context .nv-x.nv-axis")
                  .attr("transform", "translate(0," + h.range()[0] + ")"),
                ga.select(".nv-context .nv-x.nv-axis").transition().call(o)),
              G &&
                (r
                  .scale(h)
                  ._ticks($ / 36)
                ...
                ga
                  ...
                  .style("opacity", ba.length ? 1 : 0)
                  .attr("transform", "translate(" + e.range()[1] + ",0)"),
                ga.select(".nv-context .nv-y1.nv-axis").transition().call(r),
                ga.select(".nv-context .nv-y2.nv-axis").transition().call(s)),
              u.x(e).on("brush", T),
              J && u.extent(J);
            var na = ga
            ...
            pa.selectAll("rect").attr("height", $),
              pa.selectAll(".resize").append("path").attr("d", K),
        ...
        (b._options = Object.create(
          {},
          {
            ...
            margin: {
              ...
              set: function (a) {
                void 0 !== a.top && ((w.top = a.top), (x = a.top)),
            ...
            focusMargin: {
              ...
              set: function (a) {
                (y.top = void 0 !== a.top ? a.top : y.top),
                  (y.right = void 0 !== a.right ? a.right : y.right),
                  (y.bottom = void 0 !== a.bottom ? a.bottom : y.bottom),
                  (y.left = void 0 !== a.left ? a.left : y.left);
              },
            },
            duration: {
              get: function () {
      ...
      function b(F) {
        return (
          ...
          F.each(function (b) {
            ...
            var S = R.watchTransition(D, "multibar", Math.min(250, z)).delay(
              function (a, c) {
                return (c * z) / b[0].values.length;
              }
            );
            u
              ? S.attr("y", function (a, c, d) {
                  var e = 0;
                  ...
                  .attr("height", function (a, c, d) {
                    return b[d].nonStackable
                      ? Math.max(Math.abs(n(r(a, c)) - n(0)), 0) || 0
                      : Math.max(Math.abs(n(a.y + a.y0) - n(a.y0)), 0);
                  })
                  .attr("x", function (a, c, d) {
                    var e = 0;
                    return (
          ...
          D.renderEnd("multibar immediate"),
          b
        );
      }
      var c,
    ...
    (a.models.multiBarChart = function () {
      ...
      function b(D) {
        return (
          ...
          D.each(function (D) {
            ...
            a.utils.initSVG(I);
            var M = a.utils.availableWidth(n, I, l),
              N = a.utils.availableHeight(o, I, l);
            if (
              ((b.update = function () {
                0 === G ? I.call(b) : I.transition().duration(G).call(b);
              }),
              (b.container = this),
              B.setter(L(D), b.update).getter(K(D)).update(),
              (B.disabled = D.map(function (a) {
                return !!a.disabled;
              })),
              !C)
            ) {
              ...
              C = {};
              for (O in B)
                B[O] instanceof Array ? (C[O] = B[O].slice(0)) : (C[O] = B[O]);
            }
            if (
              !(
                D &&
            ...
            if (
              ...
              s
                ? "bottom" === t
                  ? (i.width(M - l.right),
                    R.select(".nv-legendWrap").datum(D).call(i),
                    (l.bottom = f.height() + i.height()),
                    (N = a.utils.availableHeight(o, I, l)),
                    R.select(".nv-legendWrap").attr(
                      "transform",
                      "translate(0," + (N + f.height()) + ")"
                    ))
                  : (i.width(M - F()),
                    R.select(".nv-legendWrap").datum(D).call(i),
                    m ||
                ...
                : R.select(".nv-legendWrap").selectAll("*").remove(),
              q)
            ) {
              var S = [
                { key: r.grouped || "Grouped", disabled: e.stacked() },
                { key: r.stacked || "Stacked", disabled: !e.stacked() },
              ];
              j.width(F()).color(["#444", "#444", "#444"]),
                R.select(".nv-controlsWrap")
                  .datum(S)
                  .attr("transform", "translate(0," + -l.top + ")")
                  .call(j);
            } else R.select(".nv-controlsWrap").selectAll("*").remove();
            P.attr("transform", "translate(" + l.left + "," + l.top + ")"),
              w &&
                R.select(".nv-y.nv-axis").attr(
                  "transform",
                  "translate(" + M + ",0)"
                ),
              e
            ...
            var T = R.select(".nv-barsWrap").datum(
              D.filter(function (a) {
                return !a.disabled;
              })
            );
            if ((T.call(e), u)) {
              f
                .scale(c)
                ._ticks(a.utils.calcTicksX(M / 100, D))
                .tickSize(-N, 0),
                R.select(".nv-x.nv-axis").attr(
                  "transform",
                  "translate(0," + d.range()[0] + ")"
                ),
                R.select(".nv-x.nv-axis").call(f);
              ...
              if ((U.selectAll("line, text").style("opacity", 1), y)) {
                ...
                var Y = d3.selectAll(".nv-x.nv-axis .nv-wrap g g text")[0]
                  .length;
                R.selectAll(".nv-x.nv-axis .nv-axisMaxMin text").attr(
                  "transform",
                  function (a, b) {
              ...
              z &&
                ...
                x &&
                  U.filter(function (a, b) {
                    ...
                    .style("opacity", 0),
                A &&
                  U.selectAll(".tick text")
                    .attr("transform", "rotate(" + A + " 0,0)")
                    .style("text-anchor", A > 0 ? "start" : "end"),
                R.select(".nv-x.nv-axis")
            ...
            v &&
              (g
                .scale(d)
                ._ticks(a.utils.calcTicksY(N / 36, D))
                .tickSize(-M, 0),
              R.select(".nv-y.nv-axis").call(g)),
              H &&
                (h
                  .width(M)
                  .height(N)
                  ...
                  .svgContainer(I)
                  .xScale(c),
                P.select(".nv-interactive").call(h)),
              ...
              H
                ? (h.dispatch.on("elementMousemove", function (a) {
                    if (void 0 != a.pointXValue) {
                      ...
                      D.filter(function (a, b) {
                        ...
                        h.tooltip.data({ value: g, index: e, series: i })(),
                        h.renderGuideLine(f);
                    }
                  }),
          ...
          I.renderEnd("multibarchart immediate"),
          b
        );
      }
      var c,
      ...
      (B.stacked = !1),
        ...
        g.orient(w ? "right" : "left").tickFormat(d3.format(",.1f")),
        k
          .duration(0)
          .valueFormatter(function (a, b) {
            return g.tickFormat()(a, b);
    ...
    (a.models.multiBarHorizontal = function () {
      ...
      function b(m) {
        return (
                ...
                ? (L.select("text")
                    ...
                    .text(function (a, b) {
                      ...
                      return void 0 === d
                        ? c
                        : d.length
                        ? c + "+" + C(Math.abs(d[1])) + "-" + C(Math.abs(d[0]))
                        : c + "Â±" + C(Math.abs(d));
                    }),
          ...
          F.renderEnd("multibarHorizontal immediate"),
          b
        );
      }
      var c,
      ...
      function b(j) {
        return (
          ...
          j.each(function (j) {
            ...
            a.utils.initSVG(z);
            var F = a.utils.availableWidth(m, z, k),
              G = a.utils.availableHeight(n, z, k);
            if (
              ((b.update = function () {
              ...
              y = {};
              for (H in x)
                x[H] instanceof Array ? (y[H] = x[H].slice(0)) : (y[H] = x[H]);
            }
            if (
              !(
                j &&
            ...
            if (
              ...
              s
                ? (h.width(F - B()),
                  ...
                  "bottom" === t
                    ? ((k.bottom = f.height() + h.height()),
                      (G = a.utils.availableHeight(n, z, k)),
                      K.select(".nv-legendWrap").attr(
                        "transform",
                        "translate(" + B() + "," + (G + f.height()) + ")"
                      ))
                    : "top" === t &&
                      (l ||
                        h.height() === k.top ||
                ...
                : K.select(".nv-legendWrap").selectAll("*").remove(),
              p)
            ) {
              var L = [
                { key: r.grouped || "Grouped", disabled: e.stacked() },
            ...
            I.attr("transform", "translate(" + k.left + "," + k.top + ")"),
              e
                .disabled(
                  j.map(function (a) {
                    return a.disabled;
            ...
            var M = K.select(".nv-barsWrap").datum(
              j.filter(function (a) {
                return !a.disabled;
              })
            );
            if ((M.transition().call(e), u)) {
              f
                .scale(c)
                ._ticks(a.utils.calcTicksY(G / 24, j))
                .tickSize(-F, 0),
                K.select(".nv-x.nv-axis").call(f);
            ...
            v &&
              (g
                .scale(d)
                ._ticks(a.utils.calcTicksX(F / 100, j))
                .tickSize(-G, 0),
              K.select(".nv-y.nv-axis").attr(
                "transform",
                "translate(0," + G + ")"
              ),
              K.select(".nv-y.nv-axis").call(g)),
              K.select(".nv-zeroLine line")
                .attr("x1", d(0))
                .attr("x2", d(0))
                .attr("y1", 0)
                .attr("y2", -G),
          ...
          F.renderEnd("multibar horizontal chart immediate"),
          b
        );
      }
      var c,
        ...
        (b._options = Object.create(
          {},
          {
            ...
            margin: {
              ...
              set: function (a) {
                void 0 !== a.top && ((k.top = a.top), (l = a.top)),
      ...
      function b(k) {
        return (
          k.each(function (k) {
            ...
            function J(a) {
              var b = 2 === a.series.yAxis ? G : F;
              (a.point.x = C.x()(a.point)),
                (a.point.y = C.y()(a.point)),
                I.duration(0)
                  .headerFormatter(function (a, b) {
                    return E.tickFormat()(a, b);
                  })
            ...
            t.domain(
              d3.extent(d3.merge(Z.concat($)), function (a) {
                return a.x;
              })
            ).range([0, P]);
            var _ = O.selectAll("g.wrap.multiChart").data([k]),
              aa = _.enter()
                ...
                .append("g");
            aa.append("g").attr("class", "nv-x nv-axis"),
              aa.append("g").attr("class", "nv-y1 nv-axis"),
              aa.append("g").attr("class", "nv-y2 nv-axis"),
              aa.append("g").attr("class", "stack1Wrap"),
              aa.append("g").attr("class", "stack2Wrap"),
              aa.append("g").attr("class", "bars1Wrap"),
              aa.append("g").attr("class", "bars2Wrap"),
              aa.append("g").attr("class", "scatters1Wrap"),
              aa.append("g").attr("class", "scatters2Wrap"),
              aa.append("g").attr("class", "lines1Wrap"),
              aa.append("g").attr("class", "lines2Wrap"),
              aa.append("g").attr("class", "legendWrap"),
            ...
            if (j) {
              ...
              H.width(da),
                  ...
                  .datum(
                    k.map(function (a) {
                      return (
                        (a.originalKey =
                          void 0 === a.originalKey ? a.key : a.originalKey),
                        (a.key = a.originalKey + (1 == a.yAxis ? "" : r)),
                        a
                      );
                    })
                  )
                ...
                ba
                  .select(".legendWrap")
                  .attr("transform", "translate(" + ea + "," + -e.top + ")");
            ...
            w
              ...
              .interpolate(n)
              .color(
                ca.filter(function (a, b) {
                  return (
                    !k[b].disabled && 1 == k[b].yAxis && "line" == k[b].type
                  );
                })
              ),
              x
                ...
                .color(
                  ca.filter(function (a, b) {
                    return (
                      !k[b].disabled && 2 == k[b].yAxis && "line" == k[b].type
                    );
                  })
                ),
              y
              ...
              A.width(P)
                ...
                .color(
                  ca.filter(function (a, b) {
                    return (
                      !k[b].disabled && 1 == k[b].yAxis && "bar" == k[b].type
                    );
                  })
                ),
              B.width(P)
                ...
                .color(
                  ca.filter(function (a, b) {
                    return (
                      !k[b].disabled && 2 == k[b].yAxis && "bar" == k[b].type
                    );
                  })
                ),
              C.width(P)
                ...
                .color(
                  ca.filter(function (a, b) {
                    return (
                      !k[b].disabled && 1 == k[b].yAxis && "area" == k[b].type
                    );
                  })
                ),
              D.width(P)
                ...
                .color(
                  ca.filter(function (a, b) {
                    return (
                      !k[b].disabled && 2 == k[b].yAxis && "area" == k[b].type
                    );
                  })
                ),
              ba.attr("transform", "translate(" + e.left + "," + e.top + ")");
            var fa = ba.select(".lines1Wrap").datum(
                R.filter(function (a) {
                  return !a.disabled;
                })
              ),
              ga = ba.select(".scatters1Wrap").datum(
                T.filter(function (a) {
                  return !a.disabled;
                })
              ),
              ha = ba.select(".bars1Wrap").datum(
                V.filter(function (a) {
                  return !a.disabled;
                })
              ),
              ia = ba.select(".stack1Wrap").datum(
                X.filter(function (a) {
                  return !a.disabled;
                })
              ),
              ja = ba.select(".lines2Wrap").datum(
                S.filter(function (a) {
                  return !a.disabled;
                })
              ),
              ka = ba.select(".scatters2Wrap").datum(
                U.filter(function (a) {
                  return !a.disabled;
                })
              ),
              la = ba.select(".bars2Wrap").datum(
                W.filter(function (a) {
                  return !a.disabled;
                })
              ),
              ma = ba.select(".stack2Wrap").datum(
                Y.filter(function (a) {
                  return !a.disabled;
                })
              ),
            ...
            if (B.stacked() && W.length) {
              ...
              oa.length > 0 &&
                (oa = oa.reduce(function (a, b) {
                  return a.map(function (a, c) {
                    return { x: a.x, y: a.y + b[c].y };
                  });
                }));
            }
            W.length && oa.push({ x: 0, y: 0 }),
              u
                .domain(
                  c ||
                    d3.extent(d3.merge(Z).concat(na), function (a) {
                      return a.y;
                    })
                )
                .range([0, Q]),
              v
                .domain(
                  d ||
                    d3.extent(d3.merge($).concat(oa), function (a) {
                      return a.y;
                    })
                )
                .range([0, Q]),
              ...
              B.yDomain(v.domain()),
              D.yDomain(v.domain()),
              X.length && d3.transition(ia).call(C),
              Y.length && d3.transition(ma).call(D),
              V.length && d3.transition(ha).call(A),
              W.length && d3.transition(la).call(B),
              R.length && d3.transition(fa).call(w),
              S.length && d3.transition(ja).call(x),
              T.length && d3.transition(ga).call(y),
              U.length && d3.transition(ka).call(z),
              E._ticks(a.utils.calcTicksX(P / 100, k)).tickSize(-Q, 0),
              ba
                .select(".nv-x.nv-axis")
                .attr("transform", "translate(0," + Q + ")"),
              d3.transition(ba.select(".nv-x.nv-axis")).call(E),
              F._ticks(a.utils.calcTicksY(Q / 36, k)).tickSize(-P, 0),
              d3.transition(ba.select(".nv-y1.nv-axis")).call(F),
              G._ticks(a.utils.calcTicksY(Q / 36, k)).tickSize(-P, 0),
              d3.transition(ba.select(".nv-y2.nv-axis")).call(G),
              ba
                .select(".nv-y1.nv-axis")
                .classed("nv-disabled", Z.length ? !1 : !0)
                .attr("transform", "translate(" + t.range()[0] + ",0)"),
              ba
                .select(".nv-y2.nv-axis")
                .classed("nv-disabled", $.length ? !1 : !0)
                .attr("transform", "translate(" + t.range()[1] + ",0)"),
              H.dispatch.on("stateChange", function (a) {
                b.update();
              }),
              q &&
                (p
                  ...
                  .svgContainer(O)
                  .xScale(t),
                _.select(".nv-interactive").call(p)),
              q
                ? (p.dispatch.on("elementMousemove", function (c) {
                    ...
                    p.tooltip
                      ...
                      .valueFormatter(p.tooltip.valueFormatter() || i)
                      .data({ value: b.x()(d, e), index: e, series: h })(),
                      p.renderGuideLine(f);
                  }),
                  p.dispatch.on("elementMouseout", function (a) {
                    M();
                  }))
                : (w.dispatch.on("elementMouseover.tooltip", o),
                  x.dispatch.on("elementMouseover.tooltip", o),
                  ...
                  y.dispatch.on("elementMouseover.tooltip", s),
                  z.dispatch.on("elementMouseover.tooltip", s),
                  ...
                  C.dispatch.on("elementMouseover.tooltip", J),
                  D.dispatch.on("elementMouseover.tooltip", J),
                  C.dispatch.on("elementMouseout.tooltip", function (a) {
                    I.hidden(!0);
                  }),
                  ...
                  A.dispatch.on("elementMouseover.tooltip", L),
                  B.dispatch.on("elementMouseover.tooltip", L),
        ...
        (b._options = Object.create(
          {},
          {
            ...
            margin: {
              ...
              set: function (a) {
                void 0 !== a.top && ((e.top = a.top), (f = a.top)),
            ...
            duration: {
              ...
              set: function (a) {
                (s = a),
                  [w, x, C, D, y, z, E, F, G].forEach(function (a) {
                    a.duration(s);
                  });
              },
            },
          ...
          B.each(function (b) {
            function A(a) {
              return x(
                o.map(function (b) {
                  if (
                    isNaN(a.values[b.key]) ||
                    isNaN(parseFloat(a.values[b.key])) ||
                    O
                  ) {
            ...
            function D() {
              ($ = p.filter(function (a) {
                ...
                (t = []),
                c.style("display", function (a) {
                  var b = $.every(function (b, c) {
                    return (isNaN(a.values[b]) ||
                ...
                F(),
                z.brush({ filters: s, active: t });
            }
            function E() {
              var a = $.length > 0 ? !0 : !1;
              s.forEach(function (a) {
                a.extent[0] === l[a.dimension].brush.y().domain()[0] &&
                  v.indexOf(a.dimension) >= 0 &&
                  (a.hasNaN = !0),
                  a.extent[1] < l[a.dimension].domain()[0] &&
                    (a.hasOnlyNaN = !0);
              }),
                z.brushEnd(t, a);
            }
            ...
            function I(a, b) {
              delete this.parentNode.__origin__,
                ...
                c.attr("d", A),
                d.attr("d", A).attr("visibility", null),
                z.dimensionsOrder(o);
            }
            function J(a) {
              var b = u[a];
            ...
            if (
              ((i = a.utils.availableWidth(g, K, f)),
              (j = a.utils.availableHeight(h, K, f)),
              a.utils.initSVG(K),
              void 0 === b[0].values)
            ) {
              var L = [];
            ...
            S.append("g").attr("class", "nv-parallelCoordinates background"),
              ...
              x.interpolate("cardinal").tension(w),
              y.orient("left");
            var U,
              V,
              W = d3.behavior
            ...
            if (((X = isNaN(X) ? k.range()[0] : X), !isNaN(X))) {
              ...
              (U = Q.select(".missingValuesline").selectAll("line").data([Y])),
                ...
                (V = Q.select(".missingValuesline")
                  .selectAll("text")
                  .data([m])),
                V.append("text").data([m]),
                V.enter().append("text"),
                V.exit().remove(),
                V.attr("y", j)
                  .attr("x", i - 92 - X / 2)
            ...
            (d = Q.select(".background").selectAll("path").data(b)),
              ...
              c
                ...
                .style("stroke-width", function (a, b) {
                  return (
                    isNaN(a.strokeWidth) && (a.strokeWidth = 1), a.strokeWidth
                  );
                })
                .attr("stroke", function (a, b) {
            ...
            (t = []),
              ...
              (s.length > 0 || !a.utils.arrayEquals(t, aa)) &&
                z.activeChanged(t);
          }),
          b
        );
        ...
        return (
          ...
          e.each(function (e) {
            ...
            if (
              ...
              (b.container = this),
              l.setter(u(m), b.update).getter(t(m)).update(),
              (l.disabled = m.map(function (a) {
                return !!a.disabled;
              })),
              (m = m.map(function (a) {
              ...
              m.forEach(function (a, b) {
                (a.originalPosition = isNaN(a.originalPosition)
                  ? b
                  : a.originalPosition),
                  (a.currentPosition = isNaN(a.currentPosition)
                    ? b
                    : a.currentPosition);
              }),
              !o)
            ...
            var v = k
              ...
              w = v
                ...
                .append("g"),
              x = v.select("g");
            w.append("g").attr("class", "nv-parallelCoordinatesWrap"),
              ...
              j
                ...
                : x.select(".nv-legendWrap").selectAll("*").remove(),
              v.attr("transform", "translate(" + f.left + "," + f.top + ")"),
              c.width(p).height(q).dimensionData(m).displayBrush(n);
            var y = x.select(".nv-parallelCoordinatesWrap ").datum(e);
            y.transition().call(c),
              c.dispatch.on("brushEnd", function (a, b) {
          ...
          s.renderEnd("parraleleCoordinateChart immediate"),
          b
        );
      }
          ...
          a.values &&
            (Object.keys(a.values).forEach(function (c) {
              ...
              if (d) {
                var e;
                (e =
                  isNaN(a.values[c]) || isNaN(parseFloat(a.values[c]))
                    ? q
                    : d.format(a.values[c])),
                  b.series.push({
        ...
        (b._options = Object.create(
          {},
          {
            ...
            margin: {
              ...
              set: function (a) {
                void 0 !== a.top && ((f.top = a.top), (g = a.top)),
                  (f.right = void 0 !== a.right ? a.right : f.right),
                  (f.bottom = void 0 !== a.bottom ? a.bottom : f.bottom),
                  (f.left = void 0 !== a.left ? a.left : f.left);
              },
        ...
        return (
          ...
          G.each(function (b) {
            ...
            var H = d - c.left - c.right,
              ...
              K = [],
              L = [];
            if (((i = d3.select(this)), 0 === B.length))
              for (var M = J - J / 10, N = z * J, O = 0; O < b[0].length; O++)
                K.push(M), L.push(N);
            else
              s
                ? ((K = B.map(function (a) {
            ...
            var P = i.selectAll(".nv-wrap.nv-pie").data(b),
              ...
              R = Q.append("g"),
              S = P.select("g"),
              T = R.append("g").attr("class", "nv-pie");
            R.append("g").attr("class", "nv-pieLabels"),
              P.attr("transform", "translate(" + c.left + "," + c.top + ")"),
              S.select(".nv-pie").attr(
                "transform",
                "translate(" + H / 2 + "," + I / 2 + ")"
              ),
              S.select(".nv-pieLabels").attr(
                "transform",
                "translate(" + H / 2 + "," + I / 2 + ")"
              ),
            ...
            for (var O = 0; O < b[0].length; O++) {
              var U = d3.svg.arc().outerRadius(K[O]),
                V = d3.svg.arc().outerRadius(K[O] + 5);
              v !== !1 && (U.startAngle(v), V.startAngle(v)),
                x !== !1 && (U.endAngle(x), V.endAngle(x)),
                q && (U.innerRadius(L[O]), V.innerRadius(L[O])),
                U.cornerRadius && y && (U.cornerRadius(y), V.cornerRadius(y)),
                D.push(U),
                E.push(V);
            }
            var W = d3.layout
            ...
            W.padAngle && w && W.padAngle(w),
              q &&
                r &&
                (T.append("text").attr("class", "nv-pie-title"),
                P.select(".nv-pie-title")
                  .style("text-anchor", "middle")
                  .text(function (a) {
                    return r;
                  })
                  .style(
                    "font-size",
                    (Math.min(H, I) * z * 2) / (r.length + 2) + "px"
                  )
                  .attr("dy", "0.35em")
                  .attr("transform", function (a, b) {
                ...
                d3.select(this).classed("hover", !1),
                  s &&
                    d3
                      ...
                      .duration(50)
                      .attr("d", D[b]),
                  C.elementMouseout({ data: a.data, index: b });
              }),
            ...
            if (
              ...
              for (var $ = [], O = 0; O < b[0].length; O++)
                $.push(D[O]),
                  m
                    ? q &&
                      (($[O] = d3.svg.arc().outerRadius(D[O].outerRadius())),
                      v !== !1 && $[O].startAngle(v),
                      x !== !1 && $[O].endAngle(x))
                    : q || $[O].innerRadius(0);
              Y.enter()
                    ...
                    if (u) {
                      ...
                      return (
                        (a.startAngle + a.endAngle) / 2 < Math.PI
                          ? (c -= 90)
                          : (c += 90),
                        "translate(" + $[b].centroid(a) + ") rotate(" + c + ")"
                      );
                    }
                    return (
                      (a.outerRadius = J + 10),
                      (a.innerRadius = J + 15),
                      "translate(" + $[b].centroid(a) + ")"
                    );
                  }),
                    c
                      .append("rect")
              ...
              var _ = {},
                ...
                ca = function (a) {
                  return (
                    Math.floor(a[0] / ba) * ba +
                    "," +
                    Math.floor(a[1] / aa) * aa
                  );
                },
                da = function (a) {
                  return (a.endAngle - a.startAngle) / (2 * Math.PI);
                };
              Y.watchTransition(F, "pie labels").attr(
                "transform",
                function (a, b) {
                  if (u) {
                    (a.outerRadius = K[b] + 10), (a.innerRadius = K[b] + 15);
                ...
                p &&
                  Y.each(function (b, c) {
                    if (this.getBBox) {
                      var d = this.getBBox(),
                        e = $[c].centroid(b),
                        f = { x: e[0] + d.x, y: e[1] + d.y },
                        g = { x: f.x + d.width, y: f.y },
                        h = { x: f.x, y: f.y + d.height },
                        i = { x: f.x + d.width, y: f.y + d.height };
                      b.visible =
                        a.utils.pointIsInArc(f, b, U) &&
                        a.utils.pointIsInArc(g, b, U) &&
                        a.utils.pointIsInArc(h, b, U) &&
                        a.utils.pointIsInArc(i, b, U);
                    }
        ...
        return (
          ...
          e.each(function (e) {
            ...
            if (
              ...
              (b.container = this),
              n.setter(u(e), b.update).getter(t(e)).update(),
              (n.disabled = e.map(function (a) {
                return !!a.disabled;
              })),
              !o)
            ) {
            ...
            if (
              ...
              if ("top" === l)
                d.width(m).key(c.x()),
                  s.select(".nv-legendWrap").datum(e).call(d),
                  g ||
                    d.height() === f.top ||
                    ((f.top = d.height()),
                    (p = a.utils.availableHeight(i, j, f))),
            ...
            s.attr("transform", "translate(" + f.left + "," + f.top + ")"),
              c.width(m).height(p);
            var y = w.select(".nv-pieWrap").datum([e]);
            d3.transition(y).call(c),
              d.dispatch.on("stateChange", function (a) {
                for (var c in a) n[c] = a[c];
          ...
          s.renderEnd("pieChart immediate"),
          b
        );
      }
      var c = a.models.pie(),
      ...
      return (
        c.dispatch.on("elementMouseover.tooltip", function (a) {
          (a.series = {
            ...
            j || (delete a.percent, delete a.series.percent),
            e.data(a).hidden(!1);
        }),
        c.dispatch.on("elementMouseout.tooltip", function (a) {
          e.hidden(!0);
    ...
    (a.models.sankey = function () {
      ...
      function c() {
        n.forEach(function (a) {
          a.value = Math.max(
            d3.sum(a.sourceLinks, i),
            d3.sum(a.targetLinks, i)
          );
        });
      }
      function d() {
      ...
      function g(a) {
        ...
        b(), e(), h();
        for (var j = 1; a > 0; --a) d((j *= 0.99)), e(), h(), c(j), e(), h();
      }
      function h() {
        function a(a, b) {
      ...
      return (
        (j.options = a.utils.optionsFunc.bind(j)),
    ...
    (a.models.sankeyChart = function () {
        ...
        return (
          a.each(function (b) {
              ...
              d3
                ...
                .attr(
                  ...
                  "translate(" +
                    a.x +
                    "," +
                    (a.y = Math.max(0, Math.min(f - a.dy, d3.event.y))) +
                    ")"
                ),
                d.relayout(),
                t.attr("d", s);
            ...
            var i = {
              ...
              l = !1;
            if (
              (("object" == typeof b.nodes && b.nodes.length) >= 0 &&
                ("object" == typeof b.links && b.links.length) >= 0 &&
                (k = !0),
              b.nodes &&
                b.nodes.length > 0 &&
                b.links &&
              ...
              return (
                ...
                console.info("Valid data format is: ", i, JSON.stringify(i)),
                r(a, "Error loading chart, data is invalid"),
                !1
              );
      ...
      var c = { top: 5, right: 0, bottom: 5, left: 0 },
        ...
        n = function (a) {
          return a.source.name + " â†’ " + a.target.name + "\n" + l(a.value);
        },
        o = function (a) {
        ...
        (b._options = Object.create(
          {},
          {
            ...
            nodeStyle: {
              ...
              set: function (a) {
                (o = void 0 !== a.fillColor ? a.fillColor : o),
                  (p = void 0 !== a.strokeColor ? a.strokeColor : p),
    ...
    (a.models.scatter = function () {
      ...
      function d(a) {
        var c,
          ...
          f = b(a),
          g = !1;
        for (c = 1; c < arguments.length; c += 2)
          (d = arguments[c]),
            (e = arguments[c + 1](a[0], a[1])),
        ...
        return (
          ...
          b.each(function (b) {
            function V() {
              if (((Y = !1), !E)) return !1;
              if (U === !0) {
                ha.select(".nv-point-paths").selectAll("path").remove();
                var c = d3.merge(
                  b.map(function (b, c) {
                    return b.values
                      .map(function (b, d) {
                        var e = x(b, d),
                          f = y(b, d);
                        return [
                          a.utils.NaNtoZero(u(e)) + 1e-4 * Math.random(),
                          a.utils.NaNtoZero(v(f)) + 1e-4 * Math.random(),
                          c,
                          d,
                          b,
                        ];
                ...
                c.length < 3 &&
                  (c.push([u.range()[0] - 20, v.range()[0] - 20, null, null]),
                  c.push([u.range()[1] + 20, v.range()[1] + 20, null, null]),
                  c.push([u.range()[0] - 20, v.range()[0] + 20, null, null]),
                  c.push([u.range()[1] + 20, v.range()[1] - 20, null, null]));
                ...
                for (var f = 0; f < c.length - 1; )
                  Math.abs(c[f][0] - c[f + 1][0]) < e &&
                  Math.abs(c[f][1] - c[f + 1][1]) < e
                    ? c.splice(f + 1, 1)
                    : f++;
            ...
            t = d3.select(this);
            var _ = a.utils.availableWidth(o, t, n),
              aa = a.utils.availableHeight(p, t, n);
            a.utils.initSVG(t),
              b.forEach(function (a, b) {
                a.values.forEach(function (a) {
                  a.series = b;
            ...
            var ba = "function" == typeof e.yScale().base,
              ca =
                M && N && Q
                  ? []
                  : d3.merge(
            ...
            if (
              ...
              G && b[0]
                ? u.range(
                    O || [
                      (_ * H + _) / (2 * b[0].values.length),
                      _ - (_ * (1 + H)) / (2 * b[0].values.length),
                    ]
                  )
                : u.range(O || [0, _]),
              ba)
            ...
            w
              ...
              .range(R || $),
              (S =
                u.domain()[0] === u.domain()[1] ||
                v.domain()[0] === v.domain()[1]),
              u.domain()[0] === u.domain()[1] &&
                (u.domain()[0]
                  ? u.domain([
                      u.domain()[0] - 0.01 * u.domain()[0],
                      u.domain()[1] + 0.01 * u.domain()[1],
                    ])
                  : u.domain([-1, 1])),
              v.domain()[0] === v.domain()[1] &&
                (v.domain()[0]
                  ? v.domain([
                      v.domain()[0] - 0.01 * v.domain()[0],
                      v.domain()[1] + 0.01 * v.domain()[1],
                    ])
                  : v.domain([-1, 1])),
              isNaN(u.domain()[0]) && u.domain([-1, 1]),
              isNaN(v.domain()[0]) && v.domain([-1, 1]),
              (f = f || u),
              (g = g || v),
              (h = h || w);
            ...
            (i = u.domain()),
              (j = j || []),
              (ga = ga || j[0] !== v.domain()[0] || j[1] !== v.domain()[1]),
              (j = v.domain());
            var ha = t.selectAll("g.nv-wrap.nv-scatter").data([b]),
              ia = ha
                .enter()
                .append("g")
                .attr("class", "nvd3 nv-wrap nv-scatter nv-chart-" + s),
              ja = ia.append("defs"),
              ka = ia.append("g"),
              la = ha.select("g");
            ha.classed("nv-single-point", S),
              ka.append("g").attr("class", "nv-groups"),
              ka.append("g").attr("class", "nv-point-paths"),
              ia.append("g").attr("class", "nv-point-clips"),
              ha.attr("transform", "translate(" + n.left + "," + n.top + ")"),
              ja
                .append("clipPath")
                .attr("id", "nv-edge-clip-" + s)
                .append("rect")
                .attr("transform", "translate( -10, -10)"),
              ha
                .select("#nv-edge-clip-" + s + " rect")
                .attr("width", _ + 20)
                .attr("height", aa > 0 ? aa + 20 : 0),
              la.attr("clip-path", I ? "url(#nv-edge-clip-" + s + ")" : ""),
              (Y = !0);
            var ma = ha
              .select(".nv-groups")
              .selectAll(".nv-group")
            ...
            ma
              ...
              ma
                ...
                .classed("nv-noninteractive", !E)
                .classed("hover", function (a) {
                  return a.hover;
                }),
              ma
                .watchTransition(Z, "scatter: groups")
                .style("fill", function (a, b) {
                  return q(a, b);
                })
                .style("stroke", function (a, b) {
            ...
            if (
              (na
                ...
                .attr("transform", function (b) {
                  return (
                    "translate(" +
                    a.utils.NaNtoZero(f(x(b[0], b[1]))) +
                    "," +
                    a.utils.NaNtoZero(g(y(b[0], b[1]))) +
                    ")"
                  );
                })
                .attr(
              ...
              na.exit().each(c).remove(),
              ma
                .exit()
                .selectAll("path.nv-point")
                .watchTransition(Z, "scatter exit")
                .attr("transform", function (b) {
                  return (
                    "translate(" +
                    a.utils.NaNtoZero(u(x(b[0], b[1]))) +
                    "," +
                    a.utils.NaNtoZero(v(y(b[0], b[1]))) +
                    ")"
                  );
                })
                .remove(),
              na
                ...
                .watchTransition(Z, "scatter points")
                .attr("transform", function (b) {
                  return (
                    "translate(" +
                    a.utils.NaNtoZero(u(x(b[0], b[1]))) +
              ...
              oa
                ...
                oa
                  .watchTransition(Z, "scatter labels")
                  .attr("transform", function (b) {
                    var c =
                      a.utils.NaNtoZero(u(x(b[0], b[1]))) +
                      Math.sqrt(w(z(b[0], b[1])) / Math.PI) +
            ...
            W ? (clearTimeout(m), (m = setTimeout(V, W))) : V(),
              (f = u.copy()),
              (g = v.copy()),
              (h = w.copy()),
              (k = o),
      ...
      var f,
        ...
        l,
        m,
        n = { top: 0, right: 0, bottom: 0, left: 0 },
        o = null,
        p = null,
        q = a.utils.defaultColor(),
        r = null,
        s = Math.floor(1e5 * Math.random()),
        t = null,
        u = d3.scale.linear(),
        v = d3.scale.linear(),
        w = d3.scale.linear(),
        ...
        X = !1,
        Y = !1,
        Z = a.utils.renderWatch(T, V),
        $ = [16, 256],
        _ = {};
      return (
        (e.dispatch = T),
        (e.options = a.utils.optionsFunc.bind(e)),
        ...
        (e._options = Object.create(
          {},
          {
            ...
            margin: {
              ...
              set: function (a) {
                (n.top = void 0 !== a.top ? a.top : n.top),
                  (n.right = void 0 !== a.right ? a.right : n.right),
                  (n.bottom = void 0 !== a.bottom ? a.bottom : n.bottom),
                  (n.left = void 0 !== a.left ? a.left : n.left);
              },
    ...
    (a.models.scatterChart = function () {
        ...
        return (
          ...
          A.each(function (A) {
            ...
            if (
              ...
              (b.container = this),
              x.setter(H(A), b.update).getter(G(A)).update(),
              (x.disabled = A.map(function (a) {
                return !!a.disabled;
              })),
              !y)
            ) {
            ...
            if (
              ...
              return a.utils.noData(b, n), F.renderEnd("scatter immediate"), b;
            n.selectAll(".nv-noData").remove(),
              (p = c.xScale()),
              (q = c.yScale());
            ...
            if (
              ...
              N.append("g").attr("class", "nv-regressionLinesWrap"),
              N.append("g").attr("class", "nv-distWrap"),
              N.append("g").attr("class", "nv-legendWrap"),
              w &&
                O.select(".nv-y.nv-axis").attr(
                  "transform",
                  "translate(" + I + ",0)"
                ),
              t)
              ...
              var P = I;
              f.width(P),
                L.select(".nv-legendWrap").datum(A).call(f),
                k ||
                  f.height() === j.top ||
                  ((j.top = f.height()),
                  (J = a.utils.availableHeight(m, n, j))),
            ...
            L.attr("transform", "translate(" + j.left + "," + j.top + ")"),
              c
                .width(I)
                .height(J)
                .color(
              ...
              L.select(".nv-scatterWrap")
                ...
                .call(c),
              L.select(".nv-regressionLinesWrap").attr(
                "clip-path",
                "url(#nv-edge-clip-" + c.id() + ")"
              );
            var Q = L.select(".nv-regressionLinesWrap")
            ...
            R.enter()
              ...
              R.filter(function (a) {
                ...
                .watchTransition(F, "scatterPlusLineChart: regline")
                .attr("x1", p.range()[0])
                .attr("x2", p.range()[1])
                .attr("y1", function (a, b) {
              ...
              u &&
                (d
                  .scale(p)
                  ._ticks(a.utils.calcTicksX(I / 100, A))
                  .tickSize(-J, 0),
                O.select(".nv-x.nv-axis")
                  .attr("transform", "translate(0," + q.range()[0] + ")")
                  .call(d)),
              v &&
                (e
                  .scale(q)
                  ._ticks(a.utils.calcTicksY(J / 36, A))
                  .tickSize(-I, 0),
                O.select(".nv-y.nv-axis").call(e)),
              r &&
                (g
                  .getData(c.x())
                  .scale(p)
                ...
                N.select(".nv-distWrap")
                  .append("g")
                  .attr("class", "nv-distributionX"),
                O.select(".nv-distributionX")
                  .attr("transform", "translate(0," + q.range()[0] + ")")
                  .datum(
                    A.filter(function (a) {
                      return !a.disabled;
              ...
              s &&
                ...
                O.select(".nv-distributionY")
                  .attr("transform", "translate(" + (w ? I : -h.size()) + ",0)")
                  .datum(
                    A.filter(function (a) {
                      return !a.disabled;
                    })
          ...
          F.renderEnd("scatter with line immediate"),
          b
        );
      }
      ...
      c.xScale(p).yScale(q),
        ...
        e.orient(w ? "right" : "left").tickPadding(10),
        g.axis("x"),
        h.axis("y"),
        i
          .headerFormatter(function (a, b) {
    ...
    (a.models.sparkline = function () {
      ...
      function b(k) {
        return (
          ...
          k.each(function (b) {
            ...
            var w = t.selectAll("circle.nv-point").data(function (a) {
              ...
              var c = a.map(function (a, b) {
                ...
                f = b(c.length - 1);
              return [q ? e : null, q ? d : null, r ? f : null].filter(
                function (a) {
                  return null != a;
                }
              );
            });
            w.enter().append("circle"),
              w.exit().remove(),
              w
          ...
          t.renderEnd("sparkline immediate"),
          b
        );
      }
      var c,
    ...
    (a.models.sparklinePlus = function () {
      ...
      function b(p) {
        return (
          ...
          r.renderEnd("sparklinePlus immediate"),
          b
        );
      }
      var c,
    ...
    (a.models.stackedArea = function () {
      ...
      function b(n) {
        return (
          ...
          n.each(function (n) {
            ...
            C.append("g").attr("class", "nv-areaWrap"),
              ...
              s
                ...
                .x(k)
                .y(function (a) {
                  return void 0 !== a.display
                    ? a.display.y + a.display.y0
                    : void 0;
                })
                .color(
                  n.map(function (a, b) {
            ...
            H.enter()
              ...
              H.exit().remove(),
              H.style("fill", function (a, b) {
                return a.color || h(a, a.seriesIndex);
              }).style("stroke", function (a, b) {
                return a.color || h(a, a.seriesIndex);
              }),
              H.watchTransition(v, "stackedArea path").attr(
                "d",
                function (a, b) {
                  return F(a.values, b);
                }
          ...
          v.renderEnd("stackedArea immediate"),
          b
        );
      }
      var c,
      ...
      return (
        (b.dispatch = u),
        (b.scatter = s),
        s.dispatch.on("elementClick", function () {
      ...
      function b(k) {
        return (
          ...
          k.each(function (k) {
            function D() {
              u &&
                X.select(".nv-focus .nv-x.nv-axis")
            ...
            function L() {
              if (v) {
                ...
                X.select(".nv-focus .nv-y.nv-axis")
                  .transition()
                  .duration(0)
                  .call(g);
              }
            ...
            function Q(a) {
              var b = X.select(".nv-focus .nv-stackedWrap").datum(
                k
                  .filter(function (a) {
                    return !a.disabled;
                  })
            ...
            if (
              ...
              (b.container = this),
              B.setter(O(k), b.update).getter(N(k)).update(),
            ...
            if (
              ...
              return a.utils.noData(b, R), b;
            R.selectAll(".nv-noData").remove(),
              (c = e.xScale()),
              (d = e.yScale());
            ...
            Y.append("g").attr("class", "nv-background").append("rect"),
              Y.append("g").attr("class", "nv-x nv-axis"),
              Y.append("g").attr("class", "nv-y nv-axis"),
              Y.append("g").attr("class", "nv-stackedWrap"),
              Y.append("g").attr("class", "nv-interactive");
            W.append("g").attr("class", "nv-focusWrap");
            if (s) {
              var Z = r && "top" === t ? S - F : S;
              if (
                (h.width(Z),
                X.select(".nv-legendWrap").datum(k).call(h),
                "bottom" === t)
              ) {
                var $ = (u ? 12 : 0) + 10;
                (m.bottom = Math.max(h.height() + $, m.bottom)),
                  (T = a.utils.availableHeight(p, R, m) - (x ? l.height() : 0));
                var _ = T + $;
                X.select(".nv-legendWrap").attr(
                  "transform",
                  "translate(0," + _ + ")"
                );
              } else
                "top" === t &&
                  (n ||
                    ...
                    ((m.top = h.height()),
                    (T =
                      a.utils.availableHeight(p, R, m) - (x ? l.height() : 0))),
                  X.select(".nv-legendWrap").attr(
                    "transform",
                    "translate(" + (S - Z) + "," + -m.top + ")"
                  ));
            ...
            if (r) {
              ...
              (F = (G.length / 3) * 260),
                ...
                i.width(F).color(["#444", "#444", "#444"]),
                X.select(".nv-controlsWrap").datum(aa).call(i);
              var ba = Math.max(i.height(), s && "top" === t ? h.height() : 0);
              m.top != ba &&
                ((m.top = ba),
                (T = a.utils.availableHeight(p, R, m) - (x ? l.height() : 0))),
                X.select(".nv-controlsWrap").attr(
                  "transform",
                  "translate(0," + -m.top + ")"
                );
            } else X.select(".nv-controlsWrap").selectAll("*").remove();
            V.attr("transform", "translate(" + m.left + "," + m.top + ")"),
              w &&
                X.select(".nv-y.nv-axis").attr(
                  "transform",
                  "translate(" + S + ",0)"
                ),
              y &&
                (j
                  ...
                  .svgContainer(R)
                  .xScale(c),
                V.select(".nv-interactive").call(j)),
              X.select(".nv-focus .nv-background rect")
                .attr("width", S)
                .attr("height", T),
              e
                .width(S)
            ...
            var ca = X.select(".nv-focus .nv-stackedWrap").datum(
              k.filter(function (a) {
                return !a.disabled;
              })
            );
            if (
              (u &&
                f
                  .scale(c)
                  ._ticks(a.utils.calcTicksX(S / 100, k))
                  .tickSize(-T, 0),
              v)
            ) {
              var da;
              (da =
                "wiggle" === e.offset() ? 0 : a.utils.calcTicksY(T / 36, k)),
                g.scale(d)._ticks(da).tickSize(-S, 0);
            }
            if (x) {
              l.width(S),
                X.select(".nv-focusWrap")
                  .attr(
                    "transform",
                    "translate(0," + (T + m.bottom + l.margin().top) + ")"
                  )
                  .datum(
                    k.filter(function (a) {
                      return !a.disabled;
            ...
            e.dispatch.on("areaClick.toggle", function (a) {
              ...
              j.dispatch.on("elementMousemove", function (c) {
                  ...
                  (k
                    ...
                    .forEach(function (j, n) {
                      ...
                      if (
                        (null != p &&
                          p > 0 &&
                          (e.highlightPoint(n, f, !0), (m = !0)),
                        n !== k.length - 1 || m || e.highlightPoint(n, f, !0),
                        "undefined" != typeof o)
                      ) {
                        "undefined" == typeof d && (d = o),
                          "undefined" == typeof g &&
                            (g = b.xScale()(b.x()(o, f)));
                        var r =
                          "expand" == e.style() ? o.display.y : b.y()(o, f);
                        h.push({
                          key: j.key,
                          value: r,
                ...
                z &&
                  ...
                  h.length >= 2 &&
                  !l &&
                  h.push({ key: A, value: i, total: !0 });
                var p = b.x()(d, f),
                  r = j.tooltip.valueFormatter();
                "expand" === e.style() || "stack_percent" === e.style()
                  ? (K || (K = r), (r = d3.format(".1%")))
                  : K && ((r = K), (K = null)),
                  j.tooltip.valueFormatter(r).data({ value: p, series: h })(),
                  j.renderGuideLine(g);
              }),
              j.dispatch.on("elementMouseout", function (a) {
                e.clearHighlights();
              ...
              E.on("changeState", function (a) {
                "undefined" != typeof a.disabled &&
                  ...
                  "undefined" != typeof a.style &&
                    (e.style(a.style), (M = a.style)),
                  b.update();
              });
          }),
          L.renderEnd("stacked Area chart immediate"),
          b
        );
      }
      var c,
        ...
        (b._options = Object.create(
          {},
          {
            ...
            margin: {
              ...
              set: function (a) {
                void 0 !== a.top && ((m.top = a.top), (n = a.top)),
            ...
            focusMargin: {
              ...
              set: function (a) {
                (l.margin.top = void 0 !== a.top ? a.top : l.margin.top),
                  (l.margin.right =
                    void 0 !== a.right ? a.right : l.margin.right),
                  (l.margin.bottom =
    ...
    (a.models.sunburst = function () {
      ...
      function g(a) {
        ...
        return function (c) {
          var d = b(c);
          return (
            (a.x0 = d.x), (a.dx0 = d.dx), (a.y0 = d.y), (a.dy0 = d.dy), J(d)
          );
        };
      }
      function h(a) {
      ...
      function i(a) {
        a.forEach(function (a) {
          var b = B(a),
            c = I[b];
          c
            ? ((a.dx0 = c.dx), (a.x0 = c.x), (a.dy0 = c.dy), (a.y0 = c.y))
      ...
      function k(f) {
        return (
          ...
          f.each(function (f) {
            (v = d3.select(this)),
              (m = a.utils.availableWidth(q, v, p)),
              (n = a.utils.availableHeight(r, v, p)),
              (o = Math.min(m, n) / 2),
              G.range([0, o]);
            ...
            z
              ...
              .style("fill", function (a) {
                return a.color
                  ? a.color
                  : w(C ? (a.children ? a : a.parent).name : a.name);
              })
              .style("stroke", "#FFF")
              .on("click", function (a, b) {
              ...
              x &&
                ...
                l
                  ...
                  .attr("transform", function (a) {
                    ...
                    if (0 === a.depth)
                      return "rotate(0)translate(" + (d / 2) * -1 + ",0)";
                    var e = c(a),
                      f = b(a);
                    return 0 === f
                      ? "rotate(" + e + ")translate(" + (G(a.y) + 5) + ",0)"
                      : "rotate(" +
                          e +
                          ")translate(" +
                          (G(a.y) + d + 5) +
          ...
          K.renderEnd("sunburst immediate"),
          k
        );
      }
      var l,
      ...
      return (
        (k.dispatch = E),
        (k.options = a.utils.optionsFunc.bind(k)),
            ...
            return (
              ...
              d && d.length
                ? (h.selectAll(".nv-noData").remove(),
                  c.width(i).height(j).margin(e),
                  void h.call(c))
                : (a.utils.noData(b, h), b)
            );
          }),
          n.renderEnd("sunburstChart immediate"),
          b
        );
      }
